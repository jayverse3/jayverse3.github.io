...
var ee = class {
	...
	isUnderlineColorDefault() {
		return this.bg & 268435456 && ~this.extended.underlineColor ? !(this.extended.underlineColor & 50331648) : this.isFgDefault();
	}
	getUnderlineStyle() {
...
var w = y("CharSizeService"), ye = y("CoreBrowserService"), be = y("MouseService"), T = y("RenderService"), xe = y("SelectionService"), Se = y("CharacterJoinerService"), Ce = y("ThemeService"), we = y("LinkProviderService"), Te = new class {
	constructor() {
		this.listeners = [], this.unexpectedErrorHandler = function(e) {
			setTimeout(() => {
				throw e.stack ? je.isErrorNoTelemetry(e) ? new je(e.message + "\n\n" + e.stack) : /* @__PURE__ */ Error(e.message + "\n\n" + e.stack) : e;
			}, 0);
		};
	}
	addListener(e) {
...
function Ee(e) {
	Oe(e) || Te.onUnexpectedError(e);
}
var De = "Canceled";
function Oe(e) {
	return e instanceof ke || e instanceof Error && e.name === De && e.message === De;
}
var ke = class extends Error {
	constructor() {
		super(De), this.name = this.message;
	}
};
function Ae(e) {
...
var Ge = class e {
	...
	add(t) {
		...
		return Ve(t, this), this._isDisposed ? e.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
	}
	delete(e) {
		if (e) {
	...
	deleteAndLeak(e) {
		e && this._toDispose.has(e) && (this._toDispose.delete(e), Ve(e, null));
	}
};
Ge.DISABLE_DISPOSED_WARNING = !1;
var Ke = Ge, D = class {
	constructor() {
		this._store = new Ke(), ze(this), Ve(this._store, this);
	}
	dispose() {
...
var qe = class {
	...
	set value(e) {
		this._isDisposed || e === this._value || (this._value?.dispose(), e && Ve(e, this), this._value = e);
	}
	clear() {
		this.value = void 0;
	}
	dispose() {
		this._isDisposed = !0, Be(this), this._value?.dispose(), this._value = void 0;
	}
	clearAndLeak() {
		let e = this._value;
		return this._value = void 0, e && Ve(e, null), e;
	}
}, Je = typeof window == "object" ? window : globalThis, Ye = class e {
	constructor(t) {
...
}, Ze = globalThis.performance && typeof globalThis.performance.now == "function", Qe = class e {
	static create(t) {
		return new e(t);
	}
	constructor(e) {
		this._now = Ze && e === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
	}
	stop() {
...
((e) => {
	e.None = () => D.None;
	function t(e, t) {
		return d(e, () => {}, 0, void 0, !0, void 0, t);
	}
	e.defer = t;
	function n(e) {
		return (t, n = null, r) => {
	...
	e.once = n;
	function r(e, t, n) {
		return l((n, r = null, i) => e((e) => n.call(r, t(e)), null, i), n);
	}
	e.map = r;
	function i(e, t, n) {
		return l((n, r = null, i) => e((e) => {
			t(e), n.call(r, e);
		}, null, i), n);
	}
	e.forEach = i;
	function a(e, t, n) {
		return l((n, r = null, i) => e((e) => t(e) && n.call(r, e), null, i), n);
	}
	e.filter = a;
	function o(e) {
		return e;
	...
	e.signal = o;
	function s(...e) {
		return (t, n = null, r) => u(We(...e.map((e) => e((e) => t.call(n, e)))), r);
	}
	e.any = s;
	function c(e, t, n, i) {
		let a = n;
		return r(e, (e) => (a = t(a, e), a), i);
	}
	e.reduce = c;
	function l(e, t) {
		let n, r = new A({
	...
	function d(e, t, n = 100, r = !1, i = !1, a, o) {
		let s, c, l, u = 0, d, f = new A({
			...
			onWillAddFirstListener() {
				s = e((e) => {
					...
					}, typeof n == "number" ? (clearTimeout(l), l = setTimeout(d, n)) : l === void 0 && (l = 0, queueMicrotask(d));
				});
			},
	...
	class ee {
		...
		filter(e) {
			return this.steps.push((t) => e(t) ? t : _), this;
		}
		reduce(e, t) {
			let n = t;
		...
		latch(e = (e, t) => e === t) {
			...
			return this.steps.push((r) => {
				let i = t || !e(r, n);
				return t = !1, n = r, i ? r : _;
			}), this;
		}
		evaluate(e) {
			for (let t of this.steps) if (e = t(e), e === _) break;
			return e;
		}
	}
	function te(e, t, n = (e) => e) {
		let r = (...e) => i.fire(n(...e)), i = new A({
	...
	function se(e, t) {
		return new oe(e, t).emitter.event;
	}
	e.fromObservable = se;
	function ce(e) {
		return (t, n, r) => {
			...
			return r instanceof Ke ? r.add(s) : Array.isArray(r) && r.push(s), s;
		};
	}
...
var $e = class e {
	...
	start(e) {
		this._stopWatch = new Qe(), this.listenerCount = e;
	}
	stop() {
		if (this._stopWatch) {
...
$e.all = /* @__PURE__ */ new Set(), $e._idPool = 0;
var et = $e, tt = -1, nt = class e {
...
var rt = nt, it = class e {
	...
	constructor(e) {
		this.value = e, this.id = st++;
	}
}, lt = 2, A = class {
	constructor(e) {
		this._size = 0, this._options = e, this._leakageMon = tt > 0 || this._options?.leakWarningThreshold ? new rt(e?.onListenerError ?? Ee, this._options?.leakWarningThreshold ?? tt) : void 0, this._perfMon = this._options?._profName ? new et(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
	}
	dispose() {
	...
	get event() {
		return this._event ??= (e, t, n) => {
			if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
				...
				console.warn(e);
				let t = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], n = new ot(`${e}. HINT: Stack shows most frequent listener (${t[1]}-times)`, t[0]);
				return (this._options?.onListenerError || Ee)(n), D.None;
			}
			if (this._disposed) return D.None;
			t && (e = e.bind(t));
			let r = new ct(e), i;
			this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (r.stack = it.create(), i = this._leakageMon.check(r.stack, this._size + 1)), this._listeners ? this._listeners instanceof ct ? (this._deliveryQueue ??= new ut(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._size++;
			let a = E(() => {
				i?.(), this._removeListener(r);
			});
			return n instanceof Ke ? n.add(a) : Array.isArray(n) && n.push(a), a;
		}, this._event;
	}
	_removeListener(e) {
	...
	fire(e) {
		if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) {
			if (this._listeners instanceof ct) this._deliver(this._listeners, e);
			else {
...
ft.INSTANCE.onDidChangeZoomLevel;
function mt(e) {
	return ft.INSTANCE.getZoomFactor(e);
}
ft.INSTANCE.onDidChangeFullscreen;
var ht = typeof navigator == "object" ? navigator.userAgent : "", gt = ht.indexOf("Firefox") >= 0, _t = ht.indexOf("AppleWebKit") >= 0, vt = ht.indexOf("Chrome") >= 0, yt = !vt && ht.indexOf("Safari") >= 0;
ht.indexOf("Electron/"), ht.indexOf("Android");
var bt = !1;
if (typeof Je.matchMedia == "function") {
	let e = Je.matchMedia("(display-mode: standalone) or (display-mode: window-controls-overlay)"), t = Je.matchMedia("(display-mode: fullscreen)");
	bt = e.matches, pt(Je, e, ({ matches: e }) => {
		bt && t.matches || (bt = e);
	});
}
function xt() {
...
var St = "en", Ct = !1, wt = !1, Tt = !1, Et = !1, Dt = !1, Ot = St, kt, At = globalThis, jt;
typeof At.vscode < "u" && typeof At.vscode.process < "u" ? jt = At.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (jt = process);
var Mt = typeof jt?.versions?.electron == "string" && jt?.type === "renderer";
if (typeof jt == "object") {
	Ct = jt.platform === "win32", wt = jt.platform === "darwin", Tt = jt.platform === "linux", Tt && jt.env.SNAP && jt.env.SNAP_REVISION, jt.env.CI || jt.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Ot = St;
	let e = jt.env.VSCODE_NLS_CONFIG;
	if (e) try {
		let t = JSON.parse(e);
		t.userLocale, t.osLocale, Ot = t.resolvedLanguage || St, t.languagePack?.translationsConfigFile;
	} catch {}
	Et = !0;
} else typeof navigator == "object" && !Mt ? (kt = navigator.userAgent, Ct = kt.indexOf("Windows") >= 0, wt = kt.indexOf("Macintosh") >= 0, (kt.indexOf("Macintosh") >= 0 || kt.indexOf("iPad") >= 0 || kt.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, Tt = kt.indexOf("Linux") >= 0, kt?.indexOf("Mobi"), Dt = !0, Ot = globalThis._VSCODE_NLS_LANGUAGE || St, navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
var Nt = Ct, Pt = wt, Ft = Tt, It = Et;
Dt && typeof At.importScripts == "function" && At.origin;
var Lt = kt, Rt = Ot, zt;
((e) => {
	function t() {
		return Rt;
	...
	e.value = t;
	function n() {
		return Rt.length === 2 ? Rt === "en" : Rt.length >= 3 && Rt[0] === "e" && Rt[1] === "n" && Rt[2] === "-";
	}
...
var Bt = typeof At.postMessage == "function" && !At.importScripts;
(() => {
	if (Bt) {
		let e = [];
		At.addEventListener("message", (t) => {
...
var Vt = !!(Lt && Lt.indexOf("Chrome") >= 0);
Lt && Lt.indexOf("Firefox"), !Vt && Lt && Lt.indexOf("Safari"), Lt && Lt.indexOf("Edg/"), Lt && Lt.indexOf("Android");
var Ht = typeof navigator == "object" ? navigator : {};
It || document.queryCommandSupported && document.queryCommandSupported("copy") || Ht && Ht.clipboard && Ht.clipboard.writeText, It || Ht && Ht.clipboard && Ht.clipboard.readText, It || xt() || Ht.keyboard, "ontouchstart" in Je || Ht.maxTouchPoints, Je.PointerEvent && ("ontouchstart" in Je || navigator.maxTouchPoints);
var Ut = class {
	constructor() {
...
}, Wt = new Ut(), Gt = new Ut(), Kt = new Ut(), qt = Array(230), Jt;
((e) => {
	function t(e) {
	...
	e.toString = t;
	function n(e) {
		return Wt.strToKeyCode(e);
	}
	e.fromString = n;
	function r(e) {
		return Gt.keyCodeToStr(e);
	}
	...
	function a(e) {
		return Gt.strToKeyCode(e) || Kt.strToKeyCode(e);
	}
...
var Qt = Pt ? 256 : 2048, $t = 512, en = 1024, tn = Pt ? 2048 : 256, nn = class {
	...
	_computeKeybinding() {
		...
		let t = 0;
		return this.ctrlKey && (t |= Qt), this.altKey && (t |= $t), this.shiftKey && (t |= en), this.metaKey && (t |= tn), t |= e, t;
	}
	_computeKeyCodeChord() {
		let e = 0;
		return this.keyCode !== 5 && this.keyCode !== 4 && this.keyCode !== 6 && this.keyCode !== 57 && (e = this.keyCode), new Yt(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, e);
	}
...
var on = class {
	...
	constructor(e, t) {
		...
		let n = on.getPositionOfChildWindowRelativeToAncestorWindow(e, t.view);
	...
	constructor(e, t = 0, n = 0) {
		...
		if (e) {
			...
			if (typeof t.wheelDeltaY < "u") this.deltaY = r ? t.wheelDeltaY / (120 * i) : t.wheelDeltaY / 120;
			else if (typeof n.VERTICAL_AXIS < "u" && n.axis === n.VERTICAL_AXIS) this.deltaY = -n.detail / 3;
			else if (e.type === "wheel") {
				let t = e;
				this.deltaY = t.deltaMode === t.DOM_DELTA_LINE ? gt && !Pt ? -e.deltaY / 3 : -e.deltaY : -e.deltaY / 40;
			}
			if (typeof t.wheelDeltaX < "u") this.deltaX = yt && Nt ? -(t.wheelDeltaX / 120) : r ? t.wheelDeltaX / (120 * i) : t.wheelDeltaX / 120;
			else if (typeof n.HORIZONTAL_AXIS < "u" && n.axis === n.HORIZONTAL_AXIS) this.deltaX = -e.detail / 3;
			else if (e.type === "wheel") {
				let t = e;
				this.deltaX = t.deltaMode === t.DOM_DELTA_LINE ? gt && !Pt ? -e.deltaX / 3 : -e.deltaX : -e.deltaX / 40;
			}
			this.deltaY === 0 && this.deltaX === 0 && e.wheelDelta && (this.deltaY = r ? e.wheelDelta / (120 * i) : e.wheelDelta / 120);
		}
	}
	preventDefault() {
		this.browserEvent?.preventDefault();
...
((e) => {
	function t(t) {
		return t === e.None || t === e.Cancelled || t instanceof dn ? !0 : !t || typeof t != "object" ? !1 : typeof t.isCancellationRequested == "boolean" && typeof t.onCancellationRequested == "function";
	}
...
var dn = class {
	...
	get onCancellationRequested() {
		return this._isCancelled ? ln : (this._emitter ||= new A(), this._emitter.event);
	}
	dispose() {
	...
	cancelAndSet(e, t) {
		if (this._isDisposed) throw new Me("Calling 'cancelAndSet' on a disposed TimeoutTimer");
		this.cancel(), this._token = setTimeout(() => {
			this._token = -1, e();
		}, t);
	}
	setIfNotSet(e, t) {
		if (this._isDisposed) throw new Me("Calling 'setIfNotSet' on a disposed TimeoutTimer");
	...
	cancelAndSet(e, t, n = globalThis) {
		if (this.isDisposed) throw new Me("Calling 'cancelAndSet' on a disposed IntervalTimer");
		this.cancel();
		let r = n.setInterval(() => {
			e();
		}, t);
		...
		return {
			next: async () => {
				do {
					...
					await k.toPromise(this._onStateChanged.event);
				} while (1);
			},
...
function _n(e, t) {
	switch (typeof e) {
		case "object": return e === null ? vn(349, t) : Array.isArray(e) ? xn(e, t) : Sn(e, t);
		case "string": return bn(e, t);
		case "boolean": return yn(e, t);
		case "number": return vn(e, t);
		case "undefined": return vn(937, t);
		default: return vn(617, t);
	}
}
function vn(e, t) {
	return (t << 5) - t + e | 0;
...
function yn(e, t) {
	return vn(e ? 433 : 863, t);
}
function bn(e, t) {
	t = vn(149417, t);
	for (let n = 0, r = e.length; n < r; n++) t = vn(e.charCodeAt(n), t);
	return t;
}
function xn(e, t) {
	return t = vn(104579, t), e.reduce((e, t) => _n(t, e), t);
}
function Sn(e, t) {
	return t = vn(181387, t), Object.keys(e).sort().reduce((t, n) => (t = bn(n, t), _n(e[n], t)), t);
}
var { registerWindow: Cn, getWindow: wn, getDocument: Tn, getWindows: En, getWindowsCount: Dn, getWindowId: On, getWindowById: kn, hasWindow: An, onDidRegisterWindow: jn, onWillUnregisterWindow: Mn, onDidUnregisterWindow: Nn } = function() {
	let e = /* @__PURE__ */ new Map(), t = {
		window: Je,
		disposables: new Ke()
	};
	e.set(Je.vscodeWindowId, t);
	let n = new A(), r = new A(), i = new A();
	function a(n, r) {
	...
	return {
		...
		registerWindow(t) {
			if (e.has(t.vscodeWindowId)) return D.None;
			let a = new Ke(), o = {
				window: t,
				disposables: a.add(new Ke())
			};
			return e.set(t.vscodeWindowId, o), a.add(E(() => {
				e.delete(t.vscodeWindowId), r.fire(t);
			})), a.add(j(t, M.BEFORE_UNLOAD, () => {
				i.fire(t);
			})), n.fire(o), a;
		},
		getWindows() {
		...
		getWindow(e) {
			...
			let n = e;
			return n?.view ? n.view.window : Je;
		},
		getDocument(e) {
...
var Ln = function(e, t, n, r) {
	let i = n;
	return t === "click" || t === "mousedown" || t === "contextmenu" ? i = Fn(wn(e), n) : (t === "keydown" || t === "keypress" || t === "keyup") && (i = In(n)), j(e, t, i, r);
}, Rn, zn = class extends pn {
	constructor(e) {
		super(), this.defaultTarget = e && wn(e);
	}
	cancelAndSet(e, t, n) {
...
(function() {
	let e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map(), i = (i) => {
		n.set(i, !1);
		let a = e.get(i) ?? [];
		for (t.set(i, a), e.set(i, []), r.set(i, !0); a.length > 0;) a.sort(Bn.sort), a.shift().execute();
		r.set(i, !1);
	};
	Rn = (t, r, a = 0) => {
		let o = On(t), s = new Bn(r, a), c = e.get(o);
...
Vn.None = new Vn(0, 0);
function Hn(e) {
	let t = e.getBoundingClientRect(), n = wn(e);
	return {
...
new class {
	...
	observe(e, t, n) {
		...
		let i = gn(n), a = r.get(i);
		if (a) a.users += 1;
		else {
			let o = new A(), s = new MutationObserver((e) => o.fire(e));
			s.observe(e, n);
			let c = a = {
				users: 1,
				observer: s,
...
var M = {
	...
	DROP: "drop",
	DRAG_END: "dragend",
	ANIMATION_START: _t ? "webkitAnimationStart" : "animationstart",
	ANIMATION_END: _t ? "webkitAnimationEnd" : "animationend",
	ANIMATION_ITERATION: _t ? "webkitAnimationIteration" : "animationiteration"
}, Un = class {
	constructor(e) {
...
var Gn = class {
	constructor() {
		this._hooks = new Ke(), this._pointerMoveCallback = null, this._onStopCallback = null;
	}
	dispose() {
	...
	startMonitoring(e, t, n, r, i) {
		...
		this._hooks.add(j(a, M.POINTER_MOVE, (e) => {
			if (e.buttons !== n) {
				this.stopMonitoring(!0);
				return;
			}
			e.preventDefault(), this._pointerMoveCallback(e);
		})), this._hooks.add(j(a, M.POINTER_UP, (e) => this.stopMonitoring(!0)));
	}
};
function Kn(e, t, n) {
	let r = null, i = null;
...
var qn;
((e) => (e.Tap = "-xterm-gesturetap", e.Change = "-xterm-gesturechange", e.Start = "-xterm-gesturestart", e.End = "-xterm-gesturesend", e.Contextmenu = "-xterm-gesturecontextmenu"))(qn ||= {});
var Jn = class e extends D {
	constructor() {
		super(), this.dispatched = !1, this.targets = new Xe(), this.ignoreTargets = new Xe(), this.activeTouches = {}, this.handle = null, this._lastSetTapCountTime = 0, this._register(k.runAndSubscribe(jn, ({ window: e, disposables: t }) => {
			t.add(j(e.document, "touchstart", (e) => this.onTouchStart(e), { passive: !1 })), t.add(j(e.document, "touchend", (t) => this.onTouchEnd(e, t))), t.add(j(e.document, "touchmove", (e) => this.onTouchMove(e), { passive: !1 }));
		}, {
			window: Je,
	...
	static addTarget(t) {
		return e.isTouchDevice() ? (e.INSTANCE ||= He(new e()), E(e.INSTANCE.targets.push(t))) : D.None;
	}
	static ignoreTarget(t) {
		return e.isTouchDevice() ? (e.INSTANCE ||= He(new e()), E(e.INSTANCE.ignoreTargets.push(t))) : D.None;
	}
	static isTouchDevice() {
		return "ontouchstart" in Je || navigator.maxTouchPoints > 0;
	}
	dispose() {
	...
	onTouchStart(e) {
		...
		for (let n = 0, r = e.targetTouches.length; n < r; n++) {
			...
			let i = this.newGestureEvent(qn.Start, r.target);
	...
	onTouchEnd(t, n) {
		...
		for (let a = 0, o = n.changedTouches.length; a < o; a++) {
			...
			if (c < e.HOLD_DELAY && Math.abs(s.initialPageX - Ne(s.rollingPageX)) < 30 && Math.abs(s.initialPageY - Ne(s.rollingPageY)) < 30) {
				let e = this.newGestureEvent(qn.Tap, s.initialTarget);
				e.pageX = Ne(s.rollingPageX), e.pageY = Ne(s.rollingPageY), this.dispatchEvent(e);
			} else if (c >= e.HOLD_DELAY && Math.abs(s.initialPageX - Ne(s.rollingPageX)) < 30 && Math.abs(s.initialPageY - Ne(s.rollingPageY)) < 30) {
				let e = this.newGestureEvent(qn.Contextmenu, s.initialTarget);
				e.pageX = Ne(s.rollingPageX), e.pageY = Ne(s.rollingPageY), this.dispatchEvent(e);
			} else if (i === 1) {
				let e = Ne(s.rollingPageX), n = Ne(s.rollingPageY), i = Ne(s.rollingTimestamps) - s.rollingTimestamps[0], a = e - s.rollingPageX[0], o = n - s.rollingPageY[0], c = [...this.targets].filter((e) => s.initialTarget instanceof Node && e.contains(s.initialTarget));
				this.inertia(t, c, r, Math.abs(a) / i, a > 0 ? 1 : -1, e, Math.abs(o) / i, o > 0 ? 1 : -1, n);
			}
			this.dispatchEvent(this.newGestureEvent(qn.End, s.initialTarget)), delete this.activeTouches[o.identifier];
		}
	...
	dispatchEvent(t) {
		...
		} else (t.type === qn.Change || t.type === qn.Contextmenu) && (this._lastSetTapCountTime = 0);
	...
	inertia(t, n, r, i, a, o, s, c, l) {
		this.handle = Rn(t, () => {
			...
			let h = this.newGestureEvent(qn.Change);
	...
	onTouchMove(e) {
		...
		for (let n = 0, r = e.changedTouches.length; n < r; n++) {
			...
			let i = this.activeTouches[r.identifier], a = this.newGestureEvent(qn.Change, i.initialTarget);
			a.translationX = r.pageX - Ne(i.rollingPageX), a.translationY = r.pageY - Ne(i.rollingPageY), a.pageX = r.pageX, a.pageY = r.pageY, this.dispatchEvent(a), i.rollingPageX.length > 3 && (i.rollingPageX.shift(), i.rollingPageY.shift(), i.rollingTimestamps.shift()), i.rollingPageX.push(r.pageX), i.rollingPageY.push(r.pageY), i.rollingTimestamps.push(t);
		}
		this.dispatched &&= (e.preventDefault(), e.stopPropagation(), !1);
	}
};
Jn.SCROLL_FRICTION = -.005, Jn.HOLD_DELAY = 700, Jn.CLEAR_TAP_COUNT_TIME = 400, r([Kn], Jn, "isTouchDevice", 1);
var Yn = Jn, Xn = class extends D {
	onclick(e, t) {
		this._register(j(e, M.CLICK, (n) => t(new sn(wn(e), n))));
	}
	onmousedown(e, t) {
		this._register(j(e, M.MOUSE_DOWN, (n) => t(new sn(wn(e), n))));
	}
	onmouseover(e, t) {
		this._register(j(e, M.MOUSE_OVER, (n) => t(new sn(wn(e), n))));
	}
	onmouseleave(e, t) {
		this._register(j(e, M.MOUSE_LEAVE, (n) => t(new sn(wn(e), n))));
	}
	onkeydown(e, t) {
		this._register(j(e, M.KEY_DOWN, (e) => t(new nn(e))));
	}
	onkeyup(e, t) {
		this._register(j(e, M.KEY_UP, (e) => t(new nn(e))));
	}
	oninput(e, t) {
		this._register(j(e, M.INPUT, t));
	}
	onblur(e, t) {
		this._register(j(e, M.BLUR, t));
	}
	onfocus(e, t) {
		this._register(j(e, M.FOCUS, t));
	}
	onchange(e, t) {
		this._register(j(e, M.CHANGE, t));
	}
	ignoreGesture(e) {
		return Yn.ignoreTarget(e);
	}
}, Zn = 11, Qn = class extends Xn {
	constructor(e) {
		super(), this._onActivate = e.onActivate, this.bgDomNode = document.createElement("div"), this.bgDomNode.className = "arrow-background", this.bgDomNode.style.position = "absolute", this.bgDomNode.style.width = e.bgWidth + "px", this.bgDomNode.style.height = e.bgHeight + "px", typeof e.top < "u" && (this.bgDomNode.style.top = "0px"), typeof e.left < "u" && (this.bgDomNode.style.left = "0px"), typeof e.bottom < "u" && (this.bgDomNode.style.bottom = "0px"), typeof e.right < "u" && (this.bgDomNode.style.right = "0px"), this.domNode = document.createElement("div"), this.domNode.className = e.className, this.domNode.style.position = "absolute", this.domNode.style.width = Zn + "px", this.domNode.style.height = Zn + "px", typeof e.top < "u" && (this.domNode.style.top = e.top + "px"), typeof e.left < "u" && (this.domNode.style.left = e.left + "px"), typeof e.bottom < "u" && (this.domNode.style.bottom = e.bottom + "px"), typeof e.right < "u" && (this.domNode.style.right = e.right + "px"), this._pointerMoveMonitor = this._register(new Gn()), this._register(Ln(this.bgDomNode, M.POINTER_DOWN, (e) => this._arrowPointerDown(e))), this._register(Ln(this.domNode, M.POINTER_DOWN, (e) => this._arrowPointerDown(e))), this._pointerdownRepeatTimer = this._register(new zn()), this._pointerdownScheduleRepeatTimer = this._register(new fn());
	}
	_arrowPointerDown(e) {
		e.target && e.target instanceof Element && (this._onActivate(), this._pointerdownRepeatTimer.cancel(), this._pointerdownScheduleRepeatTimer.cancelAndSet(() => {
			this._pointerdownRepeatTimer.cancelAndSet(() => this._onActivate(), 1e3 / 24, wn(e));
	...
	constructor(e) {
		super(), this._scrollableBrand = void 0, this._onScroll = this._register(new A()), this.onScroll = this._onScroll.event, this._smoothScrollDuration = e.smoothScrollDuration, this._scheduleAtNextAnimationFrame = e.scheduleAtNextAnimationFrame, this._state = new $n(e.forceIntegerValues, 0, 0, 0, 0, 0, 0), this._smoothScrolling = null;
	}
	dispose() {
	...
	setScrollPositionSmooth(e, t) {
		...
		if (this._smoothScrolling) {
			...
			let r;
			r = t ? new ir(this._smoothScrolling.from, n, this._smoothScrolling.startTime, this._smoothScrolling.duration) : this._smoothScrolling.combine(this._state, n, this._smoothScrollDuration), this._smoothScrolling.dispose(), this._smoothScrolling = r;
		} else {
			let t = this._state.withScrollPosition(e);
			this._smoothScrolling = ir.start(this._state, t, this._smoothScrollDuration);
		}
...
var ir = class e {
	...
	_initAnimation(e, t, n) {
		if (Math.abs(e - t) > 2.5 * n) {
			let r, i;
			return e < t ? (r = e + .75 * n, i = t - .75 * n) : (r = e - .75 * n, i = t + .75 * n), rr(nr(e, r), nr(i, t), .33);
		}
		return nr(e, t);
	}
	dispose() {
	...
	_tick(e) {
		...
		return t < 1 ? new tr(this.scrollLeft(t), this.scrollTop(t), !1) : new tr(this.to.scrollLeft, this.to.scrollTop, !0);
	}
	combine(t, n, r) {
...
var sr = class extends D {
	constructor(e, t, n) {
		super(), this._visibility = e, this._visibleClassName = t, this._invisibleClassName = n, this._domNode = null, this._isVisible = !1, this._isNeeded = !1, this._rawShouldBeVisible = !1, this._shouldBeVisible = !1, this._revealTimer = this._register(new fn());
	}
	setVisibility(e) {
	...
	_applyVisibilitySetting() {
		return this._visibility === 2 ? !1 : this._visibility === 3 || this._rawShouldBeVisible;
	}
...
}, cr = 140, lr = class extends Xn {
	constructor(e) {
		super(), this._lazyRender = e.lazyRender, this._host = e.host, this._scrollable = e.scrollable, this._scrollByPage = e.scrollByPage, this._scrollbarState = e.scrollbarState, this._visibilityController = this._register(new sr(e.visibility, "visible scrollbar " + e.extraScrollbarClassName, "invisible scrollbar " + e.extraScrollbarClassName)), this._visibilityController.setIsNeeded(this._scrollbarState.isNeeded()), this._pointerMoveMonitor = this._register(new Gn()), this._shouldRender = !0, this.domNode = Wn(document.createElement("div")), this.domNode.setAttribute("role", "presentation"), this.domNode.setAttribute("aria-hidden", "true"), this._visibilityController.setDomNode(this.domNode), this.domNode.setPosition("absolute"), this._register(j(this.domNode.domNode, M.POINTER_DOWN, (e) => this._domNodePointerDown(e)));
	}
	_createArrow(e) {
		let t = this._register(new Qn(e));
		this.domNode.domNode.appendChild(t.bgDomNode), this.domNode.domNode.appendChild(t.domNode);
	}
	_createSlider(e, t, n, r) {
		this.slider = Wn(document.createElement("div")), this.slider.setClassName("slider"), this.slider.setPosition("absolute"), this.slider.setTop(e), this.slider.setLeft(t), typeof n == "number" && this.slider.setWidth(n), typeof r == "number" && this.slider.setHeight(r), this.slider.setLayerHinting(!0), this.slider.setContain("strict"), this.domNode.domNode.appendChild(this.slider.domNode), this._register(j(this.slider.domNode, M.POINTER_DOWN, (e) => {
	...
	constructor(e, t, n) {
		...
		if (super({
			...
			host: n,
			scrollbarState: new ur(t.horizontalHasArrows ? t.arrowSize : 0, t.horizontal === 2 ? 0 : t.horizontalScrollbarSize, t.vertical === 2 ? 0 : t.verticalScrollbarSize, r.width, r.scrollWidth, i.scrollLeft),
	...
	constructor(e, t, n) {
		...
		if (super({
			lazyRender: t.lazyRender,
			host: n,
			scrollbarState: new ur(t.verticalHasArrows ? t.arrowSize : 0, t.vertical === 2 ? 0 : t.verticalScrollbarSize, 0, r.height, r.scrollHeight, i.scrollTop),
...
_r.INSTANCE = new _r();
var vr = _r, yr = class extends Xn {
	constructor(e, t, n) {
		super(), this._onScroll = this._register(new A()), this.onScroll = this._onScroll.event, this._onWillScroll = this._register(new A()), this.onWillScroll = this._onWillScroll.event, this._options = xr(t), this._scrollable = n, this._register(this._scrollable.onScroll((e) => {
	...
	updateClassName(e) {
		this._options.className = e, Pt && (this._options.className += " mac"), this._domNode.className = "xterm-scrollable-element " + this._options.className;
	}
	updateOptions(e) {
	...
	delegateScrollFromMouseWheelEvent(e) {
		this._onMouseWheel(new cn(e));
	}
	_setListeningToMouseWheel(e) {
		this._mouseWheelToDispose.length > 0 !== e && (this._mouseWheelToDispose = Ue(this._mouseWheelToDispose), e) && this._mouseWheelToDispose.push(j(this._listenOnDomNode, M.MOUSE_WHEEL, (e) => {
			this._onMouseWheel(new cn(e));
		}, { passive: !1 }));
	}
	_onMouseWheel(e) {
		...
		let t = vr.INSTANCE;
		hr && t.acceptStandardWheelEvent(e);
		let n = !1;
		if (e.deltaY || e.deltaX) {
			...
			let a = !Pt && e.browserEvent && e.browserEvent.shiftKey;
			...
			if (r) {
				let e = mr * r, t = o.scrollTop - (e < 0 ? Math.floor(e) : Math.ceil(e));
				this._verticalScrollbar.writeScrollPosition(s, t);
			}
			if (i) {
				let e = mr * i, t = o.scrollLeft - (e < 0 ? Math.floor(e) : Math.ceil(e));
				this._horizontalScrollbar.writeScrollPosition(s, t);
			}
			s = this._scrollable.validateScrollPosition(s), (o.scrollLeft !== s.scrollLeft || o.scrollTop !== s.scrollTop) && (hr && this._options.mouseWheelSmoothScroll && t.isPhysicalMouseWheel() ? this._scrollable.setScrollPositionSmooth(s) : this._scrollable.setScrollPositionNow(s), n = !0);
		}
		let r = n;
	...
	_scheduleHide() {
		!this._mouseIsOver && !this._isDragging && this._hideTimeout.cancelAndSet(() => this._hide(), pr);
	}
}, br = class extends yr {
	constructor(e, t, n) {
		super(e, t, n);
...
function xr(e) {
	let t = {
		lazyRender: typeof e.lazyRender < "u" && e.lazyRender,
		...
		flipAxes: typeof e.flipAxes < "u" && e.flipAxes,
		consumeMouseWheelIfScrollbarIsNeeded: typeof e.consumeMouseWheelIfScrollbarIsNeeded < "u" && e.consumeMouseWheelIfScrollbarIsNeeded,
		alwaysConsumeMouseWheel: typeof e.alwaysConsumeMouseWheel < "u" && e.alwaysConsumeMouseWheel,
		scrollYToX: typeof e.scrollYToX < "u" && e.scrollYToX,
		...
		horizontalHasArrows: typeof e.horizontalHasArrows < "u" && e.horizontalHasArrows,
		...
		verticalHasArrows: typeof e.verticalHasArrows < "u" && e.verticalHasArrows,
		verticalSliderSize: typeof e.verticalSliderSize < "u" ? e.verticalSliderSize : 0,
		scrollByPage: typeof e.scrollByPage < "u" && e.scrollByPage
	};
	return t.horizontalSliderSize = typeof e.horizontalSliderSize < "u" ? e.horizontalSliderSize : t.horizontalScrollbarSize, t.verticalSliderSize = typeof e.verticalSliderSize < "u" ? e.verticalSliderSize : t.verticalScrollbarSize, Pt && (t.className += " mac"), t;
}
var Sr = class extends D {
	constructor(e, t, n, r, i, a, o, s) {
		super(), this._bufferService = n, this._optionsService = o, this._renderService = s, this._onRequestScrollLines = this._register(new A()), this.onRequestScrollLines = this._onRequestScrollLines.event, this._isSyncing = !1, this._isHandlingScroll = !1, this._suppressOnScrollHandler = !1;
		let c = this._register(new er({
			forceIntegerValues: !1,
			smoothScrollDuration: this._optionsService.rawOptions.smoothScrollDuration,
			scheduleAtNextAnimationFrame: (e) => Rn(r.window, e)
		}));
		this._register(this._optionsService.onSpecificOptionChange("smoothScrollDuration", () => {
		...
		})), this._scrollableElement = this._register(new br(t, {
			vertical: 1,
			horizontal: 2,
			useShadows: !1,
			...
			height: 0,
			scrollHeight: 0
		}), this._register(k.runAndSubscribe(a.onChangeColors, () => {
			this._scrollableElement.getDomNode().style.backgroundColor = a.colors.background.css;
		})), e.appendChild(this._scrollableElement.getDomNode()), this._register(E(() => this._scrollableElement.getDomNode().remove())), this._styleElement = r.mainDocument.createElement("style"), t.appendChild(this._styleElement), this._register(E(() => this._styleElement.remove())), this._register(k.runAndSubscribe(a.onChangeColors, () => {
...
var wr = class {
	...
	_refreshDrawConstants() {
		...
		Er.full = this._canvas.width, Er.left = e, Er.center = t, Er.right = e, this._refreshDrawHeightConstants(), Dr.full = 1, Dr.left = 1, Dr.center = 1 + Er.left, Dr.right = 1 + Er.left + Er.center;
	}
	_refreshDrawHeightConstants() {
		Tr.full = Math.round(2 * this._coreBrowserService.dpr);
		...
		Tr.left = t, Tr.center = t, Tr.right = t;
	}
	_refreshColorZonePadding() {
		this._colorZoneStore.setPadding({
			full: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Tr.full),
			left: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Tr.left),
			center: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Tr.center),
			right: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Tr.right)
	...
	_renderColorZone(e) {
		this._ctx.fillStyle = e.color, this._ctx.fillRect(Dr[e.position || "full"], Math.round((this._canvas.height - 1) * (e.startBufferLine / this._bufferService.buffers.active.lines.length) - Tr[e.position || "full"] / 2), Er[e.position || "full"], Math.round((this._canvas.height - 1) * ((e.endBufferLine - e.startBufferLine) / this._bufferService.buffers.active.lines.length) + Tr[e.position || "full"]));
	}
	_queueRefresh(e, t) {
...
var P;
((e) => (e.NUL = "\0", e.SOH = "", e.STX = "", e.ETX = "", e.EOT = "", e.ENQ = "", e.ACK = "", e.BEL = "\x07", e.BS = "\b", e.HT = "	", e.LF = "\n", e.VT = "\v", e.FF = "\f", e.CR = "\r", e.SO = "", e.SI = "", e.DLE = "", e.DC1 = "", e.DC2 = "", e.DC3 = "", e.DC4 = "", e.NAK = "", e.SYN = "", e.ETB = "", e.CAN = "", e.EM = "", e.SUB = "", e.ESC = "\x1B", e.FS = "", e.GS = "", e.RS = "", e.US = "", e.SP = " ", e.DEL = ""))(P ||= {});
var kr;
((e) => (e.PAD = "", e.HOP = "", e.BPH = "", e.NBH = "", e.IND = "", e.NEL = "", e.SSA = "", e.ESA = "", e.HTS = "", e.HTJ = "", e.VTS = "", e.PLD = "", e.PLU = "", e.RI = "", e.SS2 = "", e.SS3 = "", e.DCS = "", e.PU1 = "", e.PU2 = "", e.STS = "", e.CCH = "", e.MW = "", e.SPA = "", e.EPA = "", e.SOS = "", e.SGCI = "", e.SCI = "", e.CSI = "", e.ST = "", e.OSC = "", e.PM = "", e.APC = ""))(kr ||= {});
var Ar;
((e) => e.ST = `${P.ESC}\\`)(Ar ||= {});
var jr = class {
	constructor(e, t, n, r, i, a) {
	...
	_handleAnyTextareaChanges() {
		...
		setTimeout(() => {
			if (!this._isComposing) {
				...
				this._dataAlreadySent = n, t.length > e.length ? this._coreService.triggerDataEvent(n, !0) : t.length < e.length ? this._coreService.triggerDataEvent(`${P.DEL}`, !0) : t.length === e.length && t !== e && this._coreService.triggerDataEvent(t, !0);
			}
		}, 0);
	}
...
var F = 0, I = 0, L = 0, R = 0, Mr = {
	css: "#00000000",
	rgba: 0
}, z;
((e) => {
	function t(e, t, n, r) {
		return r === void 0 ? `#${Pr(e)}${Pr(t)}${Pr(n)}` : `#${Pr(e)}${Pr(t)}${Pr(n)}${Pr(r)}`;
	}
	e.toCss = t;
...
((e) => {
	function t(e, t) {
		if (R = (t.rgba & 255) / 255, R === 1) return {
			css: t.css,
			rgba: t.rgba
		};
		let n = t.rgba >> 24 & 255, r = t.rgba >> 16 & 255, i = t.rgba >> 8 & 255, a = e.rgba >> 24 & 255, o = e.rgba >> 16 & 255, s = e.rgba >> 8 & 255;
		return F = a + Math.round((n - a) * R), I = o + Math.round((r - o) * R), L = s + Math.round((i - s) * R), {
			css: z.toCss(F, I, L),
			rgba: z.toRgba(F, I, L)
		};
	}
	...
	e.isOpaque = n;
	function r(e, t, n) {
		let r = Nr.ensureContrastRatio(e.rgba, t.rgba, n);
		if (r) return z.toColor(r >> 24 & 255, r >> 16 & 255, r >> 8 & 255);
	}
	e.ensureContrastRatio = r;
	function i(e) {
		let t = (e.rgba | 255) >>> 0;
		return [F, I, L] = Nr.toChannels(t), {
			css: z.toCss(F, I, L),
			rgba: t
		};
	}
	e.opaque = i;
	function a(e, t) {
		return R = Math.round(t * 255), [F, I, L] = Nr.toChannels(e.rgba), {
			css: z.toCss(F, I, L, R),
			rgba: z.toRgba(F, I, L, R)
		};
	}
	e.opacity = a;
	function o(e, t) {
		return R = e.rgba & 255, a(e, R * t / 255);
	}
	e.multiplyOpacity = o;
	function s(e) {
		return [
...
((e) => {
	...
	function r(e) {
		if (e.match(/#[\da-f]{3,8}/i)) switch (e.length) {
			case 4: return F = parseInt(e.slice(1, 2).repeat(2), 16), I = parseInt(e.slice(2, 3).repeat(2), 16), L = parseInt(e.slice(3, 4).repeat(2), 16), z.toColor(F, I, L);
			case 5: return F = parseInt(e.slice(1, 2).repeat(2), 16), I = parseInt(e.slice(2, 3).repeat(2), 16), L = parseInt(e.slice(3, 4).repeat(2), 16), R = parseInt(e.slice(4, 5).repeat(2), 16), z.toColor(F, I, L, R);
			case 7: return {
				css: e,
		...
		if (r) return F = parseInt(r[1]), I = parseInt(r[2]), L = parseInt(r[3]), R = Math.round((r[5] === void 0 ? 1 : parseFloat(r[5])) * 255), z.toColor(F, I, L, R);
		if (!t || !n || (t.fillStyle = n, t.fillStyle = e, typeof t.fillStyle != "string") || (t.fillRect(0, 0, 1, 1), [F, I, L, R] = t.getImageData(0, 0, 1, 1).data, R !== 255)) throw Error("css.toColor: Unsupported css format");
		return {
			rgba: z.toRgba(F, I, L, R),
			css: e
		};
...
((e) => {
	function t(e, t) {
		if (R = (t & 255) / 255, R === 1) return t;
		let n = t >> 24 & 255, r = t >> 16 & 255, i = t >> 8 & 255, a = e >> 24 & 255, o = e >> 16 & 255, s = e >> 8 & 255;
		return F = a + Math.round((n - a) * R), I = o + Math.round((r - o) * R), L = s + Math.round((i - s) * R), z.toRgba(F, I, L);
	}
	e.blend = t;
	function n(e, t, n) {
		let a = H.relativeLuminance(e >> 8), o = H.relativeLuminance(t >> 8);
		if (Fr(a, o) < n) {
			if (o < a) {
				let o = r(e, t, n), s = Fr(a, H.relativeLuminance(o >> 8));
				if (s < n) {
					let r = i(e, t, n);
					return s > Fr(a, H.relativeLuminance(r >> 8)) ? o : r;
				}
				return o;
			}
			let s = i(e, t, n), c = Fr(a, H.relativeLuminance(s >> 8));
			if (c < n) {
				let i = r(e, t, n);
				return c > Fr(a, H.relativeLuminance(i >> 8)) ? s : i;
			}
			return s;
		}
	}
	...
	function r(e, t, n) {
		let r = e >> 24 & 255, i = e >> 16 & 255, a = e >> 8 & 255, o = t >> 24 & 255, s = t >> 16 & 255, c = t >> 8 & 255, l = Fr(H.relativeLuminance2(o, s, c), H.relativeLuminance2(r, i, a));
		for (; l < n && (o > 0 || s > 0 || c > 0);) o -= Math.max(0, Math.ceil(o * .1)), s -= Math.max(0, Math.ceil(s * .1)), c -= Math.max(0, Math.ceil(c * .1)), l = Fr(H.relativeLuminance2(o, s, c), H.relativeLuminance2(r, i, a));
		return (o << 24 | s << 16 | c << 8 | 255) >>> 0;
	}
	e.reduceLuminance = r;
	function i(e, t, n) {
		let r = e >> 24 & 255, i = e >> 16 & 255, a = e >> 8 & 255, o = t >> 24 & 255, s = t >> 16 & 255, c = t >> 8 & 255, l = Fr(H.relativeLuminance2(o, s, c), H.relativeLuminance2(r, i, a));
		for (; l < n && (o < 255 || s < 255 || c < 255);) o = Math.min(255, o + Math.ceil((255 - o) * .1)), s = Math.min(255, s + Math.ceil((255 - s) * .1)), c = Math.min(255, c + Math.ceil((255 - c) * .1)), l = Fr(H.relativeLuminance2(o, s, c), H.relativeLuminance2(r, i, a));
		return (o << 24 | s << 16 | c << 8 | 255) >>> 0;
	}
...
var Ir = class extends ie {
	...
	_getJoinedRanges(e, t, n, r, i) {
		...
		for (let e = 1; e < this._characterJoiners.length; e++) try {
			...
			for (let e = 0; e < t.length; e++) Lr._mergeRanges(o, t[e]);
		} catch (e) {
			console.error(e);
		}
...
var Ur = class {
	...
	createRow(e, t, n, r, i, a, o, s, c, l, u) {
		...
		for (let b = 0; b < m; b++) {
			...
			if (f.length > 0 && b === f[0][0] && fe) {
				...
				fe &&= !n || a < r[0] || a >= r[1], fe ? (de = !0, x = new Ir(this._workCell, e.translateToString(!0, r[0], r[1]), r[1] - r[0]), pe = r[1] - 1, m = x.getWidth()) : le = r[1];
			}
			...
			if (te = x.bg, ne = x.fg, ae = x.extended.ext, v = he, oe = ce, se = me, de && a >= b && a <= pe && (a = b), !this._coreService.isCursorHidden && S && this._coreService.isCursorInitialized) {
				if (y.push("xterm-cursor"), this._coreBrowserService.isFocused) o && y.push("xterm-cursor-blink"), y.push(r === "bar" ? "xterm-cursor-bar" : r === "underline" ? "xterm-cursor-underline" : "xterm-cursor-block");
					...
					case "bar":
						...
						break;
					case "underline": y.push("xterm-cursor-underline");
				}
			}
			if (x.isBold() && y.push("xterm-bold"), x.isItalic() && y.push("xterm-italic"), x.isDim() && y.push("xterm-dim"), _ = x.isInvisible() ? re : x.getChars() || re, x.isUnderline() && (y.push(`xterm-underline-${x.extended.underlineStyle}`), _ === " " && (_ = "\xA0"), !x.isUnderlineColorDefault())) {
				if (x.isUnderlineColorRGB()) h.style.textDecorationColor = `rgb(${ie.toColorRGB(x.getUnderlineColor()).join(",")})`;
				else {
			...
			let C = x.getFgColor(), ve = x.getFgColorMode(), w = x.getBgColor(), ye = x.getBgColorMode(), be = !!x.isInverse();
			if (be) {
				let e = C;
				C = w, w = e;
				let t = ve;
			...
			let T, xe, Se = !1;
			this._decorationService.forEachDecorationAtCell(b, t, void 0, (e) => {
				e.options.layer !== "top" && Se || (e.backgroundColorRGB && (ye = 50331648, w = e.backgroundColorRGB.rgba >> 8 & 16777215, T = e.backgroundColorRGB), e.foregroundColorRGB && (ve = 50331648, C = e.foregroundColorRGB.rgba >> 8 & 16777215, xe = e.foregroundColorRGB), Se = e.options.layer === "top");
			}), !Se && me && (T = this._coreBrowserService.isFocused ? p.selectionBackgroundOpaque : p.selectionInactiveBackgroundOpaque, w = T.rgba >> 8 & 16777215, ye = 50331648, Se = !0, p.selectionForeground && (ve = 50331648, C = p.selectionForeground.rgba >> 8 & 16777215, xe = p.selectionForeground)), Se && y.push("xterm-decoration-top");
			let Ce;
			switch (ye) {
				case 16777216:
				case 33554432:
					Ce = p.ansi[w], y.push(`xterm-bg-${w}`);
					break;
				case 50331648:
					Ce = z.toColor(w >> 16, w >> 8 & 255, w & 255), this._addStyle(h, `background-color:#${Wr((w >>> 0).toString(16), "0", 6)}`);
					break;
				default: be ? (Ce = p.foreground, y.push("xterm-bg-257")) : Ce = p.background;
			}
			switch (T || x.isDim() && (T = B.multiplyOpacity(Ce, .5)), ve) {
				case 16777216:
				case 33554432:
					x.isBold() && C < 8 && this._optionsService.rawOptions.drawBoldTextInBrightColors && (C += 8), this._applyMinimumContrast(h, Ce, p.ansi[C], x, T, void 0) || y.push(`xterm-fg-${C}`);
					break;
				case 50331648:
					let e = z.toColor(C >> 16 & 255, C >> 8 & 255, C & 255);
					this._applyMinimumContrast(h, Ce, e, x, T, xe) || this._addStyle(h, `color:#${Wr(C.toString(16), "0", 6)}`);
					break;
				default: this._applyMinimumContrast(h, Ce, p.foreground, x, T, xe) || be && y.push("xterm-fg-257");
			}
	...
	_applyMinimumContrast(e, t, n, r, i, a) {
		if (this._optionsService.rawOptions.minimumContrastRatio === 1 || Br(r.getCode())) return !1;
		...
		if (!i && !a && (s = o.getColor(t.rgba, n.rgba)), s === void 0) {
			...
			s = B.ensureContrastRatio(i || t, a || n, e), o.setColor((i || t).rgba, (a || n).rgba, s ?? null);
		}
...
var Jr = "xterm-dom-renderer-owner-", Yr = "xterm-rows", Xr = "xterm-fg-", Zr = "xterm-bg-", Qr = "xterm-focus", $r = "xterm-selection", ei = 1, ti = class extends D {
	constructor(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
		super(), this._terminal = e, this._document = t, this._element = n, this._screenElement = r, this._viewportElement = i, this._helperContainer = a, this._linkifier2 = o, this._charSizeService = c, this._optionsService = l, this._bufferService = u, this._coreService = d, this._coreBrowserService = f, this._themeService = p, this._terminalClass = ei++, this._rowElements = [], this._selectionRenderModel = qr(), this.onRequestRedraw = this._register(new A()).event, this._rowContainer = this._document.createElement("div"), this._rowContainer.classList.add(Yr), this._rowContainer.style.lineHeight = "normal", this._rowContainer.setAttribute("aria-hidden", "true"), this._refreshRowElements(this._bufferService.cols, this._bufferService.rows), this._selectionContainer = this._document.createElement("div"), this._selectionContainer.classList.add($r), this._selectionContainer.setAttribute("aria-hidden", "true"), this.dimensions = Vr(), this._updateDimensions(), this._register(this._optionsService.onOptionChange(() => this._handleOptionsChanged())), this._register(this._themeService.onChangeColors((e) => this._injectCss(e))), this._injectCss(this._themeService.colors), this._rowFactory = s.createInstance(Ur, document), this._element.classList.add(Jr + this._terminalClass), this._screenElement.appendChild(this._rowContainer), this._screenElement.appendChild(this._selectionContainer), this._register(this._linkifier2.onShowLinkUnderline((e) => this._handleLinkHover(e))), this._register(this._linkifier2.onHideLinkUnderline((e) => this._handleLinkLeave(e))), this._register(E(() => {
			this._element.classList.remove(Jr + this._terminalClass), this._rowContainer.remove(), this._selectionContainer.remove(), this._widthCache.dispose(), this._themeStyleElement.remove(), this._dimensionsStyleElement.remove();
		})), this._widthCache = new Gr(this._document, this._helperContainer), this._widthCache.setFont(this._optionsService.rawOptions.fontFamily, this._optionsService.rawOptions.fontSize, this._optionsService.rawOptions.fontWeight, this._optionsService.rawOptions.fontWeightBold), this._setDefaultSpacing();
	}
	_updateDimensions() {
		...
		let t = `${this._terminalSelector} .${Yr} span { display: inline-block; height: 100%; vertical-align: top;}`;
	...
	_injectCss(e) {
		...
		let t = `${this._terminalSelector} .${Yr} { pointer-events: none; color: ${e.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
		t += `${this._terminalSelector} .${Yr} .xterm-dim { color: ${B.multiplyOpacity(e.foreground, .5).css};}`, t += `${this._terminalSelector} span:not(.xterm-bold) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.xterm-bold { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.xterm-italic { font-style: italic;}`;
		let n = `blink_underline_${this._terminalClass}`, r = `blink_bar_${this._terminalClass}`, i = `blink_block_${this._terminalClass}`;
		t += `@keyframes ${n} { 50% {  border-bottom-style: hidden; }}`, t += `@keyframes ${r} { 50% {  box-shadow: none; }}`, t += `@keyframes ${i} { 0% {  background-color: ${e.cursor.css};  color: ${e.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${e.cursor.css}; }}`, t += `${this._terminalSelector} .${Yr}.${Qr} .xterm-cursor.xterm-cursor-blink.xterm-cursor-underline { animation: ${n} 1s step-end infinite;}${this._terminalSelector} .${Yr}.${Qr} .xterm-cursor.xterm-cursor-blink.xterm-cursor-bar { animation: ${r} 1s step-end infinite;}${this._terminalSelector} .${Yr}.${Qr} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: ${i} 1s step-end infinite;}${this._terminalSelector} .${Yr} .xterm-cursor.xterm-cursor-block { background-color: ${e.cursor.css}; color: ${e.cursorAccent.css};}${this._terminalSelector} .${Yr} .xterm-cursor.xterm-cursor-block:not(.xterm-cursor-blink) { background-color: ${e.cursor.css} !important; color: ${e.cursorAccent.css} !important;}${this._terminalSelector} .${Yr} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${e.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${Yr} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${e.cursor.css} inset;}${this._terminalSelector} .${Yr} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${e.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`, t += `${this._terminalSelector} .${$r} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${$r} div { position: absolute; background-color: ${e.selectionBackgroundOpaque.css};}${this._terminalSelector} .${$r} div { position: absolute; background-color: ${e.selectionInactiveBackgroundOpaque.css};}`;
		for (let [n, r] of e.ansi.entries()) t += `${this._terminalSelector} .${Xr}${n} { color: ${r.css}; }${this._terminalSelector} .${Xr}${n}.xterm-dim { color: ${B.multiplyOpacity(r, .5).css}; }${this._terminalSelector} .${Zr}${n} { background-color: ${r.css}; }`;
		t += `${this._terminalSelector} .${Xr}257 { color: ${B.opaque(e.background).css}; }${this._terminalSelector} .${Xr}257.xterm-dim { color: ${B.multiplyOpacity(B.opaque(e.background), .5).css}; }${this._terminalSelector} .${Zr}257 { background-color: ${e.foreground.css}; }`, this._themeStyleElement.textContent = t;
	}
	_setDefaultSpacing() {
	...
	handleBlur() {
		this._rowContainer.classList.remove(Qr), this.renderRows(0, this._bufferService.rows - 1);
	}
	handleFocus() {
		this._rowContainer.classList.add(Qr), this.renderRows(this._bufferService.buffer.y, this._bufferService.buffer.y);
	}
	handleSelectionChanged(e, t, n) {
...
var ni = class extends D {
	constructor(e, t, n) {
		super(), this._optionsService = n, this.width = 0, this.height = 0, this._onCharSizeChange = this._register(new A()), this.onCharSizeChange = this._onCharSizeChange.event;
		try {
			this._measureStrategy = this._register(new ai(this._optionsService));
		} catch {
			this._measureStrategy = this._register(new ii(e, t, this._optionsService));
		}
...
var ri = class extends D {
	...
	constructor(e, t, n) {
		super(), this._textarea = e, this._window = t, this.mainDocument = n, this._isFocused = !1, this._cachedIsFocused = void 0, this._screenDprMonitor = this._register(new si(this._window)), this._onDprChange = this._register(new A()), this.onDprChange = this._onDprChange.event, this._onWindowChange = this._register(new A()), this.onWindowChange = this._onWindowChange.event, this._register(this.onWindowChange((e) => this._screenDprMonitor.setWindow(e))), this._register(k.forward(this._screenDprMonitor.onDprChange, this._onDprChange)), this._register(j(this._textarea, "focus", () => this._isFocused = !0)), this._register(j(this._textarea, "blur", () => this._isFocused = !1));
	}
	get window() {
		return this._window;
	}
	...
	constructor(e) {
		super(), this._parentWindow = e, this._windowResizeListener = this._register(new qe()), this._onDprChange = this._register(new A()), this.onDprChange = this._onDprChange.event, this._outerListener = () => this._setDprAndFireIfDiffers(), this._currentDevicePixelRatio = this._parentWindow.devicePixelRatio, this._updateDpr(), this._setWindowResizeListener(), this._register(E(() => this.clearListener()));
	}
	setWindow(e) {
		this._parentWindow = e, this._setWindowResizeListener(), this._setDprAndFireIfDiffers();
	}
	_setWindowResizeListener() {
		this._windowResizeListener.value = j(this._parentWindow, "resize", () => this._setDprAndFireIfDiffers());
	}
...
var di = class {
	...
	getCoords(e, t, n, r, i) {
		return ui(window, e, t, n, r, this._charSizeService.hasValidSize, this._renderService.dimensions.css.cell.width, this._renderService.dimensions.css.cell.height, i);
	}
...
var mi = typeof process < "u" && "title" in process, hi = mi ? "node" : navigator.userAgent, gi = mi ? "node" : navigator.platform, _i = hi.includes("Firefox"), vi = hi.includes("Edge"), yi = /^((?!chrome|android).)*safari/i.test(hi);
function bi() {
	if (!yi) return 0;
	let e = hi.match(/Version\/(\d+)/);
...
var xi = [
	...
	"MacPPC",
	"Mac68K"
].includes(gi), Si = gi === "iPad", Ci = gi === "iPhone", wi = [
	"Windows",
	"Win16",
	"Win32",
	"WinCE"
].includes(gi), Ti = gi.indexOf("Linux") >= 0, Ei = /\bCrOS\b/.test(hi), Di = class {
	constructor() {
...
}, Ai = !mi && "requestIdleCallback" in window ? ki : Oi, ji = class {
	constructor() {
		this._queue = new Ai();
	}
	set(e) {
	...
	_registerIntersectionObserver(e, t) {
		if ("IntersectionObserver" in e) {
			...
			n.observe(t), this._observerDisposable.value = E(() => n.disconnect());
		}
	}
...
function Pi(e, t, n, r) {
	...
	if (!n.buffer.hasScrollback) return Li(i, a, e, t, n, r) + Ri(a, t, n, r) + zi(i, a, e, t, n, r);
	let o;
	if (a === t) return o = i > e ? "D" : "C", Ki(Math.abs(i - e), Gi(o, r));
	o = a > t ? "D" : "C";
	let s = Math.abs(a - t);
	return Ki(Ii(a > t ? e : i, n) + (s - 1) * n.cols + 1 + Fi(a > t ? i : e, n), Gi(o, r));
}
function Fi(e, t) {
	return e - 1;
}
...
function Li(e, t, n, r, i, a) {
	return Ri(t, r, i, a).length === 0 ? "" : Ki(Wi(e, t, e, t - Vi(t, i), !1, i).length, Gi("D", a));
}
function Ri(e, t, n, r) {
	let i = e - Vi(e, n), a = t - Vi(t, n);
	return Ki(Math.abs(i - a) - Bi(e, t, n), Gi(Ui(e, t), r));
}
function zi(e, t, n, r, i, a) {
	let o;
	o = Ri(t, r, i, a).length > 0 ? r - Vi(r, i) : t;
	let s = r, c = Hi(e, t, n, r, i, a);
	return Ki(Wi(e, o, n, s, c === "C", i).length, Gi(c, a));
}
function Bi(e, t, n) {
	let r = 0, i = e - Vi(e, n), a = t - Vi(t, n);
...
function Hi(e, t, n, r, i, a) {
	let o;
	return o = Ri(n, r, i, a).length > 0 ? r - Vi(r, i) : t, e < n && o <= r || e >= n && o < r ? "C" : "D";
}
function Ui(e, t) {
	return e > t ? "A" : "B";
}
...
var Yi = 50, Xi = 15, Zi = 50, Qi = 500, $i = /* @__PURE__ */ RegExp("\xA0", "g"), ea = class extends D {
	constructor(e, t, n, r, i, a, o, s, c) {
		super(), this._element = e, this._screenElement = t, this._linkifier = n, this._bufferService = r, this._coreService = i, this._mouseService = a, this._optionsService = o, this._renderService = s, this._coreBrowserService = c, this._dragScrollAmount = 0, this._enabled = !0, this._workCell = new v(), this._mouseDownTimeStamp = 0, this._oldHasSelection = !1, this._oldSelectionStart = void 0, this._oldSelectionEnd = void 0, this._onLinuxMouseSelection = this._register(new A()), this.onLinuxMouseSelection = this._onLinuxMouseSelection.event, this._onRedrawRequest = this._register(new A()), this.onRequestRedraw = this._onRedrawRequest.event, this._onSelectionChange = this._register(new A()), this.onSelectionChange = this._onSelectionChange.event, this._onRequestScrollLines = this._register(new A()), this.onRequestScrollLines = this._onRequestScrollLines.event, this._mouseMoveListener = (e) => this._handleMouseMove(e), this._mouseUpListener = (e) => this._handleMouseUp(e), this._coreService.onUserInput(() => {
			this.hasSelection && this.clearSelection();
		}), this._trimListener = this._bufferService.buffer.lines.onTrim((e) => this._handleTrim(e)), this._register(this._bufferService.buffers.onBufferActivate((e) => this._handleBufferActivate(e))), this.enable(), this._model = new qi(this._bufferService), this._activeSelectionMode = 0, this._register(E(() => {
	...
	get selectionText() {
		...
		return r.map((e) => e.replace($i, " ")).join(wi ? "\r\n" : "\n");
	}
	clearSelection() {
		this._model.clearSelection(), this._removeMouseDownListeners(), this.refresh(), this._onSelectionChange.fire();
	}
	refresh(e) {
		this._refreshAnimationFrame ||= this._coreBrowserService.window.requestAnimationFrame(() => this._refresh()), Ti && e && this.selectionText.length && this._onLinuxMouseSelection.fire(this.selectionText);
	}
	_refresh() {
	...
	_selectWordAtCursor(e, t) {
		...
		if (n) return this._model.selectionStart = [n.start.x - 1, n.start.y - 1], this._model.selectionStartLength = Ji(n, this._bufferService.cols), this._model.selectionEnd = void 0, !0;
	...
	_getMouseEventScrollAmount(e) {
		...
		return t >= 0 && t <= n ? 0 : (t > n && (t -= n), t = Math.min(Math.max(t, -Yi), Yi), t /= Yi, t / Math.abs(t) + Math.round(t * (Xi - 1)));
	}
	shouldForceSelection(e) {
		return xi ? e.altKey && this._optionsService.rawOptions.macOptionClickForcesSelection : e.shiftKey;
	}
	handleMouseDown(e) {
	...
	_addMouseDownListeners() {
		this._screenElement.ownerDocument && (this._screenElement.ownerDocument.addEventListener("mousemove", this._mouseMoveListener), this._screenElement.ownerDocument.addEventListener("mouseup", this._mouseUpListener)), this._dragScrollIntervalTimer = this._coreBrowserService.window.setInterval(() => this._dragScroll(), Zi);
	}
	...
	shouldColumnSelect(e) {
		return e.altKey && !(xi && this._optionsService.rawOptions.macOptionClickForcesSelection);
	}
	_handleMouseMove(e) {
	...
	_handleMouseUp(e) {
		...
		if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && t < Qi && e.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
			if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
				...
				if (t && t[0] !== void 0 && t[1] !== void 0) {
					let e = Pi(t[0] - 1, t[1] - 1, this._bufferService, this._coreService.decPrivateModes.applicationCursorKeys);
					this._coreService.triggerDataEvent(e, !0);
				}
			}
	...
	_selectLineAt(e) {
		...
		this._model.selectionStart = [0, t.first], this._model.selectionEnd = void 0, this._model.selectionStartLength = Ji(n, this._bufferService.cols);
	}
};
ea = r([
	i(3, b),
...
var ta = class {
	...
	return e;
})()), ra = V.toColor("#ffffff"), ia = V.toColor("#000000"), aa = V.toColor("#ffffff"), oa = ia, sa = {
	css: "rgba(255, 255, 255, 0.3)",
	rgba: 4294967117
}, ca = ra, la = class extends D {
	constructor(e) {
		super(), this._optionsService = e, this._contrastCache = new na(), this._halfContrastCache = new na(), this._onChangeColors = this._register(new A()), this.onChangeColors = this._onChangeColors.event, this._colors = {
			foreground: ra,
			background: ia,
			cursor: aa,
			cursorAccent: oa,
			selectionForeground: void 0,
			selectionBackgroundTransparent: sa,
			selectionBackgroundOpaque: B.blend(ia, sa),
			selectionInactiveBackgroundTransparent: sa,
			selectionInactiveBackgroundOpaque: B.blend(ia, sa),
			scrollbarSliderBackground: B.opacity(ra, .2),
			scrollbarSliderHoverBackground: B.opacity(ra, .4),
			scrollbarSliderActiveBackground: B.opacity(ra, .5),
			overviewRulerBorder: ra,
			ansi: U.slice(),
	...
	_setTheme(e = {}) {
		let t = this._colors;
		if (t.foreground = W(e.foreground, ra), t.background = W(e.background, ia), t.cursor = B.blend(t.background, W(e.cursor, aa)), t.cursorAccent = B.blend(t.background, W(e.cursorAccent, oa)), t.selectionBackgroundTransparent = W(e.selectionBackground, sa), t.selectionBackgroundOpaque = B.blend(t.background, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundTransparent = W(e.selectionInactiveBackground, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundOpaque = B.blend(t.background, t.selectionInactiveBackgroundTransparent), t.selectionForeground = e.selectionForeground ? W(e.selectionForeground, Mr) : void 0, t.selectionForeground === Mr && (t.selectionForeground = void 0), B.isOpaque(t.selectionBackgroundTransparent) && (t.selectionBackgroundTransparent = B.opacity(t.selectionBackgroundTransparent, .3)), B.isOpaque(t.selectionInactiveBackgroundTransparent) && (t.selectionInactiveBackgroundTransparent = B.opacity(t.selectionInactiveBackgroundTransparent, .3)), t.scrollbarSliderBackground = W(e.scrollbarSliderBackground, B.opacity(t.foreground, .2)), t.scrollbarSliderHoverBackground = W(e.scrollbarSliderHoverBackground, B.opacity(t.foreground, .4)), t.scrollbarSliderActiveBackground = W(e.scrollbarSliderActiveBackground, B.opacity(t.foreground, .5)), t.overviewRulerBorder = W(e.overviewRulerBorder, ca), t.ansi = U.slice(), t.ansi[0] = W(e.black, U[0]), t.ansi[1] = W(e.red, U[1]), t.ansi[2] = W(e.green, U[2]), t.ansi[3] = W(e.yellow, U[3]), t.ansi[4] = W(e.blue, U[4]), t.ansi[5] = W(e.magenta, U[5]), t.ansi[6] = W(e.cyan, U[6]), t.ansi[7] = W(e.white, U[7]), t.ansi[8] = W(e.brightBlack, U[8]), t.ansi[9] = W(e.brightRed, U[9]), t.ansi[10] = W(e.brightGreen, U[10]), t.ansi[11] = W(e.brightYellow, U[11]), t.ansi[12] = W(e.brightBlue, U[12]), t.ansi[13] = W(e.brightMagenta, U[13]), t.ansi[14] = W(e.brightCyan, U[14]), t.ansi[15] = W(e.brightWhite, U[15]), e.extendedAnsi) {
			let n = Math.min(t.ansi.length - 16, e.extendedAnsi.length);
			for (let r = 0; r < n; r++) t.ansi[r + 16] = W(e.extendedAnsi[r], U[r + 16]);
		}
...
var ua = class {
	...
	constructor() {
		this._services = new ua(), this._services.set(x, this);
	}
	setService(e, t) {
	...
	error: 4,
	off: 5
}, pa = "xterm.js: ", ma = class extends D {
	constructor(e) {
		super(), this._optionsService = e, this._logLevel = 5, this._updateLogLevel(), this._register(this._optionsService.onSpecificOptionChange("logLevel", () => this._updateLogLevel())), ha = this;
	}
	get logLevel() {
		return this._logLevel;
	}
	_updateLogLevel() {
		this._logLevel = fa[this._optionsService.rawOptions.logLevel];
	}
	_evalLazyOptionalParams(e) {
		for (let t = 0; t < e.length; t++) typeof e[t] == "function" && (e[t] = e[t]());
	}
	_log(e, t, n) {
		this._evalLazyOptionalParams(n), e.call(console, (this._optionsService.options.logger ? "" : pa) + t, ...n);
	}
	trace(e, ...t) {
...
ma = r([i(0, S)], ma);
var ha, ga = class extends D {
	constructor(e) {
		super(), this._maxLength = e, this.onDeleteEmitter = this._register(new A()), this.onDelete = this.onDeleteEmitter.event, this.onInsertEmitter = this._register(new A()), this.onInsert = this.onInsertEmitter.event, this.onTrimEmitter = this._register(new A()), this.onTrim = this.onTrimEmitter.event, this._array = Array(this._maxLength), this._startIndex = 0, this._length = 0;
	}
	get maxLength() {
...
}, G = 3, K = Object.freeze(new ie()), _a = 0, va = 2, ya = class e {
	constructor(e, t, n = !1) {
		this.isWrapped = n, this._combined = {}, this._extendedAttrs = {}, this._data = new Uint32Array(e * G);
	...
	get(e) {
		let t = this._data[e * G + 0], n = t & 2097151;
		return [
			this._data[e * G + 1],
	...
	set(e, t) {
		this._data[e * G + 1] = t[0], t[1].length > 1 ? (this._combined[e] = t[1], this._data[e * G + 0] = e | 2097152 | t[2] << 22) : this._data[e * G + 0] = t[1].charCodeAt(0) | t[2] << 22;
	}
	getWidth(e) {
		return this._data[e * G + 0] >> 22;
	}
	hasWidth(e) {
		return this._data[e * G + 0] & 12582912;
	}
	getFg(e) {
		return this._data[e * G + 1];
	}
	getBg(e) {
		return this._data[e * G + 2];
	}
	hasContent(e) {
		return this._data[e * G + 0] & 4194303;
	}
	getCodePoint(e) {
		let t = this._data[e * G + 0];
		return t & 2097152 ? this._combined[e].charCodeAt(this._combined[e].length - 1) : t & 2097151;
	}
	isCombined(e) {
		return this._data[e * G + 0] & 2097152;
	}
	getString(e) {
		let t = this._data[e * G + 0];
	...
	isProtected(e) {
		return this._data[e * G + 2] & 536870912;
	}
	loadCell(e, t) {
		return _a = e * G, t.content = this._data[_a + 0], t.fg = this._data[_a + 1], t.bg = this._data[_a + 2], t.content & 2097152 && (t.combinedData = this._combined[e]), t.bg & 268435456 && (t.extended = this._extendedAttrs[e]), t;
	}
	setCell(e, t) {
		t.content & 2097152 && (this._combined[e] = t.combinedData), t.bg & 268435456 && (this._extendedAttrs[e] = t.extended), this._data[e * G + 0] = t.content, this._data[e * G + 1] = t.fg, this._data[e * G + 2] = t.bg;
	}
	setCellFromCodepoint(e, t, n, r) {
		r.bg & 268435456 && (this._extendedAttrs[e] = r.extended), this._data[e * G + 0] = t | n << 22, this._data[e * G + 1] = r.fg, this._data[e * G + 2] = r.bg;
	}
	addCodepointToCell(e, t, n) {
		let r = this._data[e * G + 0];
		r & 2097152 ? this._combined[e] += g(t) : r & 2097151 ? (this._combined[e] = g(r & 2097151) + g(t), r &= -2097152, r |= 2097152) : r = t | 1 << 22, n && (r &= -12582913, r |= n << 22), this._data[e * G + 0] = r;
	}
	insertCells(e, t, n) {
	...
	resize(e, t) {
		if (e === this.length) return this._data.length * 4 * va < this._data.buffer.byteLength;
		let n = e * G;
		if (e > this.length) {
		...
		return this.length = e, n * 4 * va < this._data.buffer.byteLength;
	}
	cleanupMemory() {
		if (this._data.length * 4 * va < this._data.buffer.byteLength) {
	...
	getTrimmedLength() {
		for (let e = this.length - 1; e >= 0; --e) if (this._data[e * G + 0] & 4194303) return e + (this._data[e * G + 0] >> 22);
		return 0;
	}
	getNoBgTrimmedLength() {
		for (let e = this.length - 1; e >= 0; --e) if (this._data[e * G + 0] & 4194303 || this._data[e * G + 2] & 50331648) return e + (this._data[e * G + 0] >> 22);
		return 0;
	}
	copyCellsFrom(e, t, n, r, i) {
		let a = e._data;
		if (i) for (let i = r - 1; i >= 0; i--) {
			for (let e = 0; e < G; e++) this._data[(n + i) * G + e] = a[(t + i) * G + e];
			a[(t + i) * G + 2] & 268435456 && (this._extendedAttrs[n + i] = e._extendedAttrs[t + i]);
		}
	...
	translateToString(e, t, n, r) {
		...
		let i = "";
		for (; t < n;) {
			let e = this._data[t * G + 0], n = e & 2097151, a = e & 2097152 ? this._combined[t] : n ? g(n) : re;
...
function ba(e, t, n, r, i, a) {
	...
	for (let s = 0; s < e.length - 1; s++) {
		...
		let d = 0, f = wa(u, d, t), p = 1, m = 0;
		for (; p < u.length;) {
			let e = wa(u, p, t), r = e - m, a = n - f, o = Math.min(r, a);
...
function Ca(e, t, n) {
	let r = [], i = e.map((n, r) => wa(e, r, t)).reduce((e, t) => e + t), a = 0, o = 0, s = 0;
	for (; s < i;) {
		if (i - s < n) {
			r.push(i - s);
			break;
...
var Ta = class e {
	constructor(t) {
		this.line = t, this.isDisposed = !1, this._disposables = [], this._id = e._nextId++, this._onDispose = this.register(new A()), this.onDispose = this._onDispose.event;
	}
	get id() {
		return this._id;
	}
	dispose() {
		this.isDisposed || (this.isDisposed = !0, this.line = -1, this._onDispose.fire(), Ue(this._disposables), this._disposables.length = 0);
	}
	register(e) {
...
var Oa = 4294967295, ka = class {
	constructor(e, t, n) {
		this._hasScrollback = e, this._optionsService = t, this._bufferService = n, this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.tabs = {}, this.savedY = 0, this.savedX = 0, this.savedCurAttrData = K.clone(), this.savedCharset = Da, this.markers = [], this._nullCell = v.fromCharData([
			0,
			ne,
			1,
			0
			...
			1,
			32
		]), this._isClearing = !1, this._memoryCleanupQueue = new Ai(), this._memoryCleanupPosition = 0, this._cols = this._bufferService.cols, this._rows = this._bufferService.rows, this.lines = new ga(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
	}
	getNullCell(e) {
	...
	getBlankLine(e, t) {
		return new ya(this._bufferService.cols, this.getNullCell(e), t);
	}
	get hasScrollback() {
	...
	clear() {
		this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.lines = new ga(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
	}
	resize(e, t) {
		let n = this.getNullCell(K), r = 0, i = this._getCorrectBufferLength(t);
		if (i > this.lines.maxLength && (this.lines.maxLength = i), this.lines.length > 0) {
			...
			let a = 0;
			if (this._rows < t) for (let r = this._rows; r < t; r++) this.lines.length < t + this.ybase && (this._optionsService.rawOptions.windowsMode || this._optionsService.rawOptions.windowsPty.backend !== void 0 || this._optionsService.rawOptions.windowsPty.buildNumber !== void 0 ? this.lines.push(new ya(e, n)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + a + 1 ? (this.ybase--, a++, this.ydisp > 0 && this.ydisp--) : this.lines.push(new ya(e, n)));
	...
	_reflowLarger(e, t) {
		let n = this._optionsService.rawOptions.reflowCursorLine, r = ba(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(K), n);
		if (r.length > 0) {
			let n = xa(this.lines, r);
			Sa(this.lines, n.layout), this._reflowLargerAdjustViewport(e, t, n.countRemoved);
		}
	}
	_reflowLargerAdjustViewport(e, t, n) {
		let r = this.getNullCell(K), i = n;
		for (; i-- > 0;) this.ybase === 0 ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new ya(e, r))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
		this.savedY = Math.max(this.savedY - n, 0);
	}
	_reflowSmaller(e, t) {
		let n = this._optionsService.rawOptions.reflowCursorLine, r = this.getNullCell(K), i = [], a = 0;
		for (let o = this.lines.length - 1; o >= 0; o--) {
			...
			let l = c[c.length - 1].getTrimmedLength(), u = Ca(c, this._cols, e), d = u.length - c.length, f;
			...
			for (; g >= 0;) {
				let e = Math.min(_, h);
				if (c[m] === void 0) break;
				c[m].copyCellsFrom(c[g], _ - e, h - e, e, !0), h -= e, h === 0 && (m--, h = u[m]), _ -= e, _ === 0 && (g--, _ = wa(c, Math.max(g, 0), this._cols));
			}
	...
	reset() {
		this._normal = new ka(!0, this._optionsService, this._bufferService), this._normal.fillViewportRows(), this._alt = new ka(!1, this._optionsService, this._bufferService), this._activeBuffer = this._normal, this._onBufferActivate.fire({
...
}, ja = 2, Ma = 1, Na = class extends D {
	constructor(e) {
		super(), this.isUserScrolling = !1, this._onResize = this._register(new A()), this.onResize = this._onResize.event, this._onScroll = this._register(new A()), this.onScroll = this._onScroll.event, this.cols = Math.max(e.rawOptions.cols || 0, ja), this.rows = Math.max(e.rawOptions.rows || 0, Ma), this.buffers = this._register(new Aa(e, this)), this._register(this.buffers.onBufferActivate((e) => {
...
var Pa = {
	...
	_setupOptions() {
		let e = (e) => {
			if (!(e in Pa)) throw Error(`No option with key "${e}"`);
	...
	_sanitizeAndValidateOption(e, t) {
		switch (e) {
			case "cursorStyle":
				if (t ||= Pa[e], !La(t)) throw Error(`"${t}" is not a valid value for ${e}`);
				break;
			case "wordSeparator":
				t ||= Pa[e];
				break;
...
function Ra(e, t = 5) {
	...
	for (let r in e) n[r] = t <= 1 ? e[r] : e[r] && Ra(e[r], t - 1);
	return n;
}
var za = Object.freeze({ insertMode: !1 }), Ba = Object.freeze({
	...
	constructor(e, t, n) {
		super(), this._bufferService = e, this._logService = t, this._optionsService = n, this.isCursorInitialized = !1, this.isCursorHidden = !1, this._onData = this._register(new A()), this.onData = this._onData.event, this._onUserInput = this._register(new A()), this.onUserInput = this._onUserInput.event, this._onBinary = this._register(new A()), this.onBinary = this._onBinary.event, this._onRequestScrollToBottom = this._register(new A()), this.onRequestScrollToBottom = this._onRequestScrollToBottom.event, this.modes = Ra(za), this.decPrivateModes = Ra(Ba);
	}
	reset() {
		this.modes = Ra(za), this.decPrivateModes = Ra(Ba);
	}
...
var Wa = String.fromCharCode, Ga = {
	DEFAULT: (e) => {
		...
		return t[0] > 255 || t[1] > 255 || t[2] > 255 ? "" : `\x1B[M${Wa(t[0])}${Wa(t[1])}${Wa(t[2])}`;
	},
	SGR: (e) => {
		let t = e.action === 0 && e.button !== 4 ? "m" : "M";
		return `\x1B[<${Ua(e, !0)};${e.col};${e.row}${t}`;
	},
	SGR_PIXELS: (e) => {
		let t = e.action === 0 && e.button !== 4 ? "m" : "M";
		return `\x1B[<${Ua(e, !0)};${e.x};${e.y}${t}`;
	}
}, Ka = class extends D {
	constructor(e, t, n) {
		super(), this._bufferService = e, this._coreService = t, this._optionsService = n, this._protocols = {}, this._encodings = {}, this._activeProtocol = "", this._activeEncoding = "", this._lastEvent = null, this._wheelPartialScroll = 0, this._onProtocolChange = this._register(new A()), this.onProtocolChange = this._onProtocolChange.event;
		for (let e of Object.keys(Ha)) this.addProtocol(e, Ha[e]);
		for (let e of Object.keys(Ga)) this.addEncoding(e, Ga[e]);
		this.reset();
	}
	addProtocol(e, t) {
		this._protocols[e] = t;
...
var Xa = class {
	constructor() {
		if (this.version = "6", !J) {
			J = /* @__PURE__ */ new Uint8Array(65536), J.fill(1), J[0] = 0, J.fill(0, 1, 32), J.fill(0, 127, 160), J.fill(2, 4352, 4448), J[9001] = 2, J[9002] = 2, J.fill(2, 11904, 42192), J[12351] = 1, J.fill(2, 44032, 55204), J.fill(2, 63744, 64256), J.fill(2, 65040, 65050), J.fill(2, 65072, 65136), J.fill(2, 65280, 65377), J.fill(2, 65504, 65511);
			for (let e = 0; e < qa.length; ++e) J.fill(0, qa[e][0], qa[e][1] + 1);
		}
	}
	wcwidth(e) {
		return e < 32 ? 0 : e < 127 ? 1 : e < 65536 ? J[e] : Ya(e, Ja) ? 0 : e >= 131072 && e <= 196605 || e >= 196608 && e <= 262141 ? 2 : 1;
	}
	charProperties(e, t) {
		let n = this.wcwidth(e), r = n === 0 && t !== 0;
		if (r) {
			let e = Za.extractWidth(t);
			e === 0 ? r = !1 : e > n && (n = e);
		}
		return Za.createPropertyValue(0, n, r);
	}
}, Za = class e {
	constructor() {
		this._providers = Object.create(null), this._active = "", this._onChange = new A(), this.onChange = this._onChange.event;
		let e = new Xa();
...
var eo = 2147483647, to = 256, no = class e {
	constructor(e = 32, t = 32) {
		if (this.maxLength = e, this.maxSubParamsLength = t, t > to) throw Error("maxSubParamsLength must not be greater than 256");
	...
	addParam(e) {
		...
		this._subParamsIdx[this.length] = this._subParamsLength << 8 | this._subParamsLength, this.params[this.length++] = e > eo ? eo : e;
	}
	addSubParam(e) {
		if (this._digitIsSub = !0, this.length) {
			...
			if (e < -1) throw Error("values lesser than -1 are not allowed");
			this._subParams[this._subParamsLength++] = e > eo ? eo : e, this._subParamsIdx[this.length - 1]++;
		}
	}
	hasSubParams(e) {
	...
	addDigit(e) {
		...
		n[t - 1] = ~r ? Math.min(r * 10 + e, eo) : e;
	}
}, ro = [], io = class {
	constructor() {
		this._state = 0, this._active = ro, this._id = -1, this._handlers = Object.create(null), this._handlerFb = () => {}, this._stack = {
			paused: !1,
			loopPosition: 0,
			fallThrough: !1
		};
	...
	dispose() {
		this._handlers = Object.create(null), this._handlerFb = () => {}, this._active = ro;
	}
	reset() {
		...
		this._stack.paused = !1, this._active = ro, this._id = -1, this._state = 0;
	}
	_start() {
		if (this._active = this._handlers[this._id] || ro, !this._active.length) this._handlerFb(this._id, "START");
	...
	put(e, t, n) {
		...
		if (this._state !== 0) {
			if (this._state !== 3) {
				if (this._state === 1 && this._start(), !this._active.length) this._handlerFb(this._id, "END", e);
				else {
			...
			this._active = ro, this._id = -1, this._state = 0;
		}
	}
}, ao = class {
	constructor(e) {
	...
	constructor() {
		this._handlers = Object.create(null), this._active = oo, this._ident = 0, this._handlerFb = () => {}, this._stack = {
			paused: !1,
			loopPosition: 0,
			fallThrough: !1
		};
	...
	dispose() {
		this._handlers = Object.create(null), this._handlerFb = () => {}, this._active = oo;
	}
	registerHandler(e, t) {
		this._handlers[e] === void 0 && (this._handlers[e] = []);
		let n = this._handlers[e];
	...
	reset() {
		...
		this._stack.paused = !1, this._active = oo, this._ident = 0;
	}
	hook(e, t) {
		if (this.reset(), this._ident = e, this._active = this._handlers[e] || oo, !this._active.length) this._handlerFb(this._ident, "HOOK", t);
	...
	unhook(e, t = !0) {
		...
		this._active = oo, this._ident = 0;
	}
}, co = new no();
co.addParam(0);
var lo = class {
	constructor(e) {
		this._handler = e, this._data = "", this._params = co, this._hitLimit = !1;
	}
	hook(e) {
		this._params = e.length > 1 || e.params[0] ? e.clone() : co, this._data = "", this._hitLimit = !1;
	}
	put(e, t, n) {
		this._hitLimit || (this._data += _(e, t, n), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
	}
	unhook(e) {
		let t = !1;
		if (this._hitLimit) t = !1;
		else if (e && (t = this._handler(this._data, this._params), t instanceof Promise)) return t.then((e) => (this._params = co, this._data = "", this._hitLimit = !1, e));
		return this._params = co, this._data = "", this._hitLimit = !1, t;
	}
}, uo = class {
	constructor(e) {
	...
	let e = new uo(4095), t = Array.apply(null, Array(256)).map((e, t) => t), n = (e, n) => t.slice(e, n), r = n(32, 127), i = n(0, 24);
	...
	return e.addMany(i, 0, 3, 0), e.addMany(i, 1, 3, 1), e.add(127, 1, 0, 1), e.addMany(i, 8, 0, 8), e.addMany(i, 3, 3, 3), e.add(127, 3, 0, 3), e.addMany(i, 4, 3, 4), e.add(127, 4, 0, 4), e.addMany(i, 6, 3, 6), e.addMany(i, 5, 3, 5), e.add(127, 5, 0, 5), e.addMany(i, 2, 3, 2), e.add(127, 2, 0, 2), e.add(93, 1, 4, 8), e.addMany(r, 8, 5, 8), e.add(127, 8, 5, 8), e.addMany([
		...
		24,
		26
	], 13, 14, 0), e.add(fo, 0, 2, 0), e.add(fo, 8, 5, 8), e.add(fo, 6, 0, 6), e.add(fo, 11, 0, 11), e.add(fo, 13, 13, 13), e;
}(), mo = class extends D {
	constructor(e = po) {
		super(), this._transitions = e, this._parseStack = {
			...
			transition: 0,
			chunkPos: 0
		}, this.initialState = 0, this.currentState = this.initialState, this._params = new no(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0, this._printHandlerFb = (e, t, n) => {}, this._executeHandlerFb = (e) => {}, this._csiHandlerFb = (e, t) => {}, this._escHandlerFb = (e) => {}, this._errorHandlerFb = (e) => e, this._printHandler = this._printHandlerFb, this._executeHandlers = Object.create(null), this._csiHandlers = Object.create(null), this._escHandlers = Object.create(null), this._register(E(() => {
			this._csiHandlers = Object.create(null), this._executeHandlers = Object.create(null), this._escHandlers = Object.create(null);
		})), this._oscParser = this._register(new io()), this._dcsParser = this._register(new so()), this._errorHandler = this._errorHandlerFb, this.registerEscHandler({ final: "\\" }, () => !0);
	}
	...
	parse(e, t, n) {
		...
		if (this._parseStack.state) {
			if (this._parseStack.state === 2) this._parseStack.state = 0, a = this._parseStack.chunkPos + 1;
			else {
		...
		for (let n = a; n < t; ++n) {
			switch (r = e[n], i = this._transitions.table[this.currentState << 8 | (r < 160 ? r : fo)], i >> 4) {
				case 2:
					for (let i = n + 1;; ++i) {
						if (i >= t || (r = e[i]) < 32 || r > 126 && r < fo) {
				...
				case 12:
					...
					break;
				case 13:
					for (let i = n + 1;; ++i) if (i >= t || (r = e[i]) === 24 || r === 26 || r === 27 || r > 127 && r < fo) {
				...
				case 4:
					...
					break;
				case 5:
					for (let i = n + 1;; i++) if (i >= t || (r = e[i]) < 32 || r > 127 && r < fo) {
...
}, ho = /^([\da-f])\/([\da-f])\/([\da-f])$|^([\da-f]{2})\/([\da-f]{2})\/([\da-f]{2})$|^([\da-f]{3})\/([\da-f]{3})\/([\da-f]{3})$|^([\da-f]{4})\/([\da-f]{4})\/([\da-f]{4})$/, go = /^[\da-f]+$/;
function _o(e) {
	if (!e) return;
	let t = e.toLowerCase();
	if (t.indexOf("rgb:") === 0) {
	...
	} else if (t.indexOf("#") === 0 && (t = t.slice(1), go.exec(t) && [
		3,
		6,
		9,
		12
...
function yo(e, t = 16) {
	let [n, r, i] = e;
	return `rgb:${vo(n, t)}/${vo(r, t)}/${vo(i, t)}`;
}
var bo = {
	"(": 0,
	")": 1,
...
var wo = 5e3, To = 0, Eo = class extends D {
	constructor(e, t, n, r, i, a, o, s, c = new mo()) {
		super(), this._bufferService = e, this._charsetService = t, this._coreService = n, this._logService = r, this._optionsService = i, this._oscLinkService = a, this._coreMouseService = o, this._unicodeService = s, this._parser = c, this._parseBuffer = /* @__PURE__ */ new Uint32Array(4096), this._stringDecoder = new ee(), this._utf8Decoder = new te(), this._windowTitle = "", this._iconName = "", this._windowTitleStack = [], this._iconNameStack = [], this._curAttrData = K.clone(), this._eraseAttrDataInternal = K.clone(), this._onRequestBell = this._register(new A()), this.onRequestBell = this._onRequestBell.event, this._onRequestRefreshRows = this._register(new A()), this.onRequestRefreshRows = this._onRequestRefreshRows.event, this._onRequestReset = this._register(new A()), this.onRequestReset = this._onRequestReset.event, this._onRequestSendFocus = this._register(new A()), this.onRequestSendFocus = this._onRequestSendFocus.event, this._onRequestSyncScrollBar = this._register(new A()), this.onRequestSyncScrollBar = this._onRequestSyncScrollBar.event, this._onRequestWindowsOptionsReport = this._register(new A()), this.onRequestWindowsOptionsReport = this._onRequestWindowsOptionsReport.event, this._onA11yChar = this._register(new A()), this.onA11yChar = this._onA11yChar.event, this._onA11yTab = this._register(new A()), this.onA11yTab = this._onA11yTab.event, this._onCursorMove = this._register(new A()), this.onCursorMove = this._onCursorMove.event, this._onLineFeed = this._register(new A()), this.onLineFeed = this._onLineFeed.event, this._onScroll = this._register(new A()), this.onScroll = this._onScroll.event, this._onTitleChange = this._register(new A()), this.onTitleChange = this._onTitleChange.event, this._onColor = this._register(new A()), this.onColor = this._onColor.event, this._parseStack = {
			paused: !1,
			cursorStartX: 0,
			cursorStartY: 0,
			decodedLength: 0,
			...
			257,
			258
		], this._register(this._parser), this._dirtyRowTracker = new Do(this._bufferService), this._activeBuffer = this._bufferService.buffer, this._register(this._bufferService.buffers.onBufferActivate((e) => this._activeBuffer = e.activeBuffer)), this._parser.setCsiHandlerFallback((e, t) => {
			...
			intermediates: "$",
			final: "p"
		}, (e) => this.requestMode(e, !1)), this._parser.setExecuteHandler(P.BEL, () => this.bell()), this._parser.setExecuteHandler(P.LF, () => this.lineFeed()), this._parser.setExecuteHandler(P.VT, () => this.lineFeed()), this._parser.setExecuteHandler(P.FF, () => this.lineFeed()), this._parser.setExecuteHandler(P.CR, () => this.carriageReturn()), this._parser.setExecuteHandler(P.BS, () => this.backspace()), this._parser.setExecuteHandler(P.HT, () => this.tab()), this._parser.setExecuteHandler(P.SO, () => this.shiftOut()), this._parser.setExecuteHandler(P.SI, () => this.shiftIn()), this._parser.setExecuteHandler(kr.IND, () => this.index()), this._parser.setExecuteHandler(kr.NEL, () => this.nextLine()), this._parser.setExecuteHandler(kr.HTS, () => this.tabSet()), this._parser.registerOscHandler(0, new ao((e) => (this.setTitle(e), this.setIconName(e), !0))), this._parser.registerOscHandler(1, new ao((e) => this.setIconName(e))), this._parser.registerOscHandler(2, new ao((e) => this.setTitle(e))), this._parser.registerOscHandler(4, new ao((e) => this.setOrReportIndexedColor(e))), this._parser.registerOscHandler(8, new ao((e) => this.setHyperlink(e))), this._parser.registerOscHandler(10, new ao((e) => this.setOrReportFgColor(e))), this._parser.registerOscHandler(11, new ao((e) => this.setOrReportBgColor(e))), this._parser.registerOscHandler(12, new ao((e) => this.setOrReportCursorColor(e))), this._parser.registerOscHandler(104, new ao((e) => this.restoreIndexedColor(e))), this._parser.registerOscHandler(110, new ao((e) => this.restoreFgColor(e))), this._parser.registerOscHandler(111, new ao((e) => this.restoreBgColor(e))), this._parser.registerOscHandler(112, new ao((e) => this.restoreCursorColor(e))), this._parser.registerEscHandler({ final: "7" }, () => this.saveCursor()), this._parser.registerEscHandler({ final: "8" }, () => this.restoreCursor()), this._parser.registerEscHandler({ final: "D" }, () => this.index()), this._parser.registerEscHandler({ final: "E" }, () => this.nextLine()), this._parser.registerEscHandler({ final: "H" }, () => this.tabSet()), this._parser.registerEscHandler({ final: "M" }, () => this.reverseIndex()), this._parser.registerEscHandler({ final: "=" }, () => this.keypadApplicationMode()), this._parser.registerEscHandler({ final: ">" }, () => this.keypadNumericMode()), this._parser.registerEscHandler({ final: "c" }, () => this.fullReset()), this._parser.registerEscHandler({ final: "n" }, () => this.setgLevel(2)), this._parser.registerEscHandler({ final: "o" }, () => this.setgLevel(3)), this._parser.registerEscHandler({ final: "|" }, () => this.setgLevel(3)), this._parser.registerEscHandler({ final: "}" }, () => this.setgLevel(2)), this._parser.registerEscHandler({ final: "~" }, () => this.setgLevel(1)), this._parser.registerEscHandler({
			intermediates: "%",
			final: "@"
		...
		for (let e in q) this._parser.registerEscHandler({
			intermediates: "(",
			final: e
		...
		this._parser.registerEscHandler({
			...
			intermediates: "$",
			final: "q"
		}, new lo((e, t) => this.requestStatusString(e, t)));
	}
	getAttrData() {
	...
	_logSlowResolvingAsync(e) {
		this._logService.logLevel <= 3 && Promise.race([e, new Promise((e, t) => setTimeout(() => t("#SLOW_TIMEOUT"), wo))]).catch((e) => {
			if (e !== "#SLOW_TIMEOUT") throw e;
			console.warn(`async parser handler taking longer than ${wo} ms`);
		});
	}
	_getCurrentLinkId() {
	...
	parse(e, t) {
		...
		if (o) {
			...
			r = this._parseStack.cursorStartX, i = this._parseStack.cursorStartY, this._parseStack.paused = !1, e.length > xo && (a = this._parseStack.position + xo);
		}
		if (this._logService.logLevel <= 1 && this._logService.debug(`parsing data ${typeof e == "string" ? ` "${e}"` : ` "${Array.prototype.map.call(e, (e) => String.fromCharCode(e)).join("")}"`}`), this._logService.logLevel === 0 && this._logService.trace("parsing data (codes)", typeof e == "string" ? e.split("").map((e) => e.charCodeAt(0)) : e), this._parseBuffer.length < e.length && this._parseBuffer.length < xo && (this._parseBuffer = new Uint32Array(Math.min(e.length, xo))), o || this._dirtyRowTracker.clearRange(), e.length > xo) for (let t = a; t < e.length; t += xo) {
			let a = t + xo < e.length ? t + xo : e.length, o = typeof e == "string" ? this._stringDecoder.decode(e.substring(t, a), this._parseBuffer) : this._utf8Decoder.decode(e.subarray(t, a), this._parseBuffer);
	...
	print(e, t, n) {
		...
		for (let p = t; p < n; ++p) {
			...
			i = Za.extractWidth(t);
			let n = Za.extractShouldJoin(t), m = n ? Za.extractWidth(f) : 0;
	...
	registerCsiHandler(e, t) {
		return e.final === "t" && !e.prefix && !e.intermediates ? this._parser.registerCsiHandler(e, (e) => !Co(e.params[0], this._optionsService.rawOptions.windowOptions) || t(e)) : this._parser.registerCsiHandler(e, t);
	}
	registerDcsHandler(e, t) {
		return this._parser.registerDcsHandler(e, new lo(t));
	}
	registerEscHandler(e, t) {
		return this._parser.registerEscHandler(e, t);
	}
	registerOscHandler(e, t) {
		return this._parser.registerOscHandler(e, new ao(t));
	}
	bell() {
	...
	repeatPrecedingCharacter(e) {
		...
		if (!t) return !0;
		let n = e.params[0] || 1, r = Za.extractWidth(t), i = this._activeBuffer.x - r, a = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).getString(i), o = new Uint32Array(a.length * n), s = 0;
	...
	setModePrivate(e) {
		for (let t = 0; t < e.length; t++) switch (e.params[t]) {
			case 1:
				...
				break;
			case 2:
				this._charsetService.setgCharset(0, Da), this._charsetService.setgCharset(1, Da), this._charsetService.setgCharset(2, Da), this._charsetService.setgCharset(3, Da);
				break;
			case 3:
	...
	requestMode(e, t) {
		...
		let r = this._coreService.decPrivateModes, { activeProtocol: i, activeEncoding: a } = this._coreMouseService, o = this._coreService, { buffers: s, cols: c } = this._bufferService, { active: l, alt: u } = s, d = this._optionsService.rawOptions, f = (e, n) => (o.triggerDataEvent(`${P.ESC}[${t ? "" : "?"}${e};${n}$y`), !0), p = (e) => e ? 1 : 2, m = e.params[0];
	...
	deviceStatus(e) {
		switch (e.params[0]) {
			...
			case 6:
				...
				this._coreService.triggerDataEvent(`${P.ESC}[${e};${t}R`);
		}
		return !0;
	}
	...
	windowOptions(e) {
		if (!Co(e.params[0], this._optionsService.rawOptions.windowOptions)) return !0;
		...
		switch (e.params[0]) {
			...
			case 18:
				...
				break;
			case 22:
				(t === 0 || t === 2) && (this._windowTitleStack.push(this._windowTitle), this._windowTitleStack.length > So && this._windowTitleStack.shift()), (t === 0 || t === 1) && (this._iconNameStack.push(this._iconName), this._iconNameStack.length > So && this._iconNameStack.shift());
				break;
	...
	setHyperlink(e) {
		...
		return r ? this._createHyperlink(n, r) : !n.trim() && this._finishHyperlink();
	}
	...
	selectDefaultCharset() {
		return this._charsetService.setgLevel(0), this._charsetService.setgCharset(0, Da), !0;
	}
	selectCharset(e) {
		return e.length === 2 ? (e[0] === "/" || this._charsetService.setgCharset(bo[e[0]], q[e[1]] || Da), !0) : (this.selectDefaultCharset(), !0);
	}
	index() {
	...
	requestStatusString(e, t) {
		let n = (e) => (this._coreService.triggerDataEvent(`${P.ESC}${e}${P.ESC}\\`), !0), r = this._bufferService.buffer, i = this._optionsService.rawOptions;
	...
	markRangeDirty(e, t) {
		e > t && (To = e, e = t, t = To), e < this.start && (this.start = e), t > this.end && (this.end = t);
	}
	markAllDirty() {
...
var ko = 5e7, Ao = 12, jo = 50, Mo = class extends D {
	constructor(e) {
	...
	write(e, t) {
		if (this._pendingData > ko) throw Error("write data discarded, use flow control to avoid losing data");
		...
		for (; this._writeBuffer.length > this._bufferOffset;) {
			...
			if (r) {
				r.catch((e) => (queueMicrotask(() => {
					throw e;
				}), Promise.resolve(!1))).then((e) => performance.now() - n >= Ao ? setTimeout(() => this._innerWrite(0, e)) : this._innerWrite(n, e));
				return;
			}
			let i = this._callbacks[this._bufferOffset];
			if (i && i(), this._bufferOffset++, this._pendingData -= e.length, performance.now() - n >= Ao) break;
		}
		this._writeBuffer.length > this._bufferOffset ? (this._bufferOffset > jo && (this._writeBuffer = this._writeBuffer.slice(this._bufferOffset), this._callbacks = this._callbacks.slice(this._bufferOffset), this._bufferOffset = 0), setTimeout(() => this._innerWrite())) : (this._writeBuffer.length = 0, this._callbacks.length = 0, this._pendingData = 0, this._bufferOffset = 0), this._onWriteParsed.fire();
	}
}, No = class {
	constructor(e) {
...
No = r([i(0, b)], No);
var Po = !1, Fo = class extends D {
	constructor(e) {
		super(), this._windowsWrappingHeuristics = this._register(new qe()), this._onBinary = this._register(new A()), this.onBinary = this._onBinary.event, this._onData = this._register(new A()), this.onData = this._onData.event, this._onLineFeed = this._register(new A()), this.onLineFeed = this._onLineFeed.event, this._onResize = this._register(new A()), this.onResize = this._onResize.event, this._onWriteParsed = this._register(new A()), this.onWriteParsed = this._onWriteParsed.event, this._onScroll = this._register(new A()), this._instantiationService = new da(), this.optionsService = this._register(new Ia(e)), this._instantiationService.setService(S, this.optionsService), this._bufferService = this._register(this._instantiationService.createInstance(Na)), this._instantiationService.setService(b, this._bufferService), this._logService = this._register(this._instantiationService.createInstance(ma)), this._instantiationService.setService(me, this._logService), this.coreService = this._register(this._instantiationService.createInstance(Va)), this._instantiationService.setService(fe, this.coreService), this.coreMouseService = this._register(this._instantiationService.createInstance(Ka)), this._instantiationService.setService(de, this.coreMouseService), this.unicodeService = this._register(this._instantiationService.createInstance(Za)), this._instantiationService.setService(ge, this.unicodeService), this._charsetService = this._instantiationService.createInstance(Qa), this._instantiationService.setService(pe, this._charsetService), this._oscLinkService = this._instantiationService.createInstance(No), this._instantiationService.setService(he, this._oscLinkService), this._inputHandler = this._register(new Eo(this._bufferService, this._charsetService, this.coreService, this._logService, this.optionsService, this._oscLinkService, this.coreMouseService, this.unicodeService)), this._register(k.forward(this._inputHandler.onLineFeed, this._onLineFeed)), this._register(this._inputHandler), this._register(k.forward(this._bufferService.onResize, this._onResize)), this._register(k.forward(this.coreService.onData, this._onData)), this._register(k.forward(this.coreService.onBinary, this._onBinary)), this._register(this.coreService.onRequestScrollToBottom(() => this.scrollToBottom(!0))), this._register(this.coreService.onUserInput(() => this._writeBuffer.handleUserInput())), this._register(this.optionsService.onMultipleOptionChange(["windowsMode", "windowsPty"], () => this._handleWindowsPtyOptionChange())), this._register(this._bufferService.onScroll(() => {
		...
		})), this._writeBuffer = this._register(new Mo((e, t) => this._inputHandler.parse(e, t))), this._register(k.forward(this._writeBuffer.onWriteParsed, this._onWriteParsed));
	}
	get onScroll() {
	...
	writeSync(e, t) {
		this._logService.logLevel <= 3 && !Po && (this._logService.warn("writeSync is unreliable and will be removed soon."), Po = !0), this._writeBuffer.writeSync(e, t);
	}
	input(e, t = !0) {
		this.coreService.triggerDataEvent(e, t);
	}
	resize(e, t) {
		isNaN(e) || isNaN(t) || (e = Math.max(e, ja), t = Math.max(t, Ma), this._bufferService.resize(e, t));
	}
	scroll(e, t = !1) {
	...
	_enableWindowsWrappingHeuristics() {
		if (!this._windowsWrappingHeuristics.value) {
			let e = [];
			e.push(this.onLineFeed($a.bind(null, this._bufferService))), e.push(this.registerCsiHandler({ final: "H" }, () => ($a(this._bufferService), !1))), this._windowsWrappingHeuristics.value = E(() => {
...
function Lo(e, t, n, r) {
	...
	switch (e.keyCode) {
		case 0:
			e.key === "UIKeyInputUpArrow" ? i.key = t ? P.ESC + "OA" : P.ESC + "[A" : e.key === "UIKeyInputLeftArrow" ? i.key = t ? P.ESC + "OD" : P.ESC + "[D" : e.key === "UIKeyInputRightArrow" ? i.key = t ? P.ESC + "OC" : P.ESC + "[C" : e.key === "UIKeyInputDownArrow" && (i.key = t ? P.ESC + "OB" : P.ESC + "[B");
			break;
		case 8:
			i.key = e.ctrlKey ? "\b" : P.DEL, e.altKey && (i.key = P.ESC + i.key);
			break;
		case 9:
			if (e.shiftKey) {
				i.key = P.ESC + "[Z";
			...
			i.key = P.HT, i.cancel = !0;
			break;
		case 13:
			i.key = e.altKey ? P.ESC + P.CR : P.CR, i.cancel = !0;
			break;
		case 27:
			i.key = P.ESC, e.altKey && (i.key = P.ESC + P.ESC), i.cancel = !0;
			break;
		case 37:
			if (e.metaKey) break;
			i.key = a ? P.ESC + "[1;" + (a + 1) + "D" : t ? P.ESC + "OD" : P.ESC + "[D";
			break;
		case 39:
			if (e.metaKey) break;
			i.key = a ? P.ESC + "[1;" + (a + 1) + "C" : t ? P.ESC + "OC" : P.ESC + "[C";
			break;
		case 38:
			if (e.metaKey) break;
			i.key = a ? P.ESC + "[1;" + (a + 1) + "A" : t ? P.ESC + "OA" : P.ESC + "[A";
			break;
		case 40:
			if (e.metaKey) break;
			i.key = a ? P.ESC + "[1;" + (a + 1) + "B" : t ? P.ESC + "OB" : P.ESC + "[B";
			break;
		case 45:
			!e.shiftKey && !e.ctrlKey && (i.key = P.ESC + "[2~");
			break;
		case 46:
			i.key = a ? P.ESC + "[3;" + (a + 1) + "~" : P.ESC + "[3~";
			break;
		case 36:
			i.key = a ? P.ESC + "[1;" + (a + 1) + "H" : t ? P.ESC + "OH" : P.ESC + "[H";
			break;
		case 35:
			i.key = a ? P.ESC + "[1;" + (a + 1) + "F" : t ? P.ESC + "OF" : P.ESC + "[F";
			break;
		case 33:
			e.shiftKey ? i.type = 2 : i.key = e.ctrlKey ? P.ESC + "[5;" + (a + 1) + "~" : P.ESC + "[5~";
			break;
		case 34:
			e.shiftKey ? i.type = 3 : i.key = e.ctrlKey ? P.ESC + "[6;" + (a + 1) + "~" : P.ESC + "[6~";
			break;
		case 112:
			i.key = a ? P.ESC + "[1;" + (a + 1) + "P" : P.ESC + "OP";
			break;
		case 113:
			i.key = a ? P.ESC + "[1;" + (a + 1) + "Q" : P.ESC + "OQ";
			break;
		case 114:
			i.key = a ? P.ESC + "[1;" + (a + 1) + "R" : P.ESC + "OR";
			break;
		case 115:
			i.key = a ? P.ESC + "[1;" + (a + 1) + "S" : P.ESC + "OS";
			break;
		case 116:
			i.key = a ? P.ESC + "[15;" + (a + 1) + "~" : P.ESC + "[15~";
			break;
		case 117:
			i.key = a ? P.ESC + "[17;" + (a + 1) + "~" : P.ESC + "[17~";
			break;
		case 118:
			i.key = a ? P.ESC + "[18;" + (a + 1) + "~" : P.ESC + "[18~";
			break;
		case 119:
			i.key = a ? P.ESC + "[19;" + (a + 1) + "~" : P.ESC + "[19~";
			break;
		case 120:
			i.key = a ? P.ESC + "[20;" + (a + 1) + "~" : P.ESC + "[20~";
			break;
		case 121:
			i.key = a ? P.ESC + "[21;" + (a + 1) + "~" : P.ESC + "[21~";
			break;
		case 122:
			i.key = a ? P.ESC + "[23;" + (a + 1) + "~" : P.ESC + "[23~";
			break;
		case 123:
			i.key = a ? P.ESC + "[24;" + (a + 1) + "~" : P.ESC + "[24~";
			break;
		default: if (e.ctrlKey && !e.shiftKey && !e.altKey && !e.metaKey) e.keyCode >= 65 && e.keyCode <= 90 ? i.key = String.fromCharCode(e.keyCode - 64) : e.keyCode === 32 ? i.key = P.NUL : e.keyCode >= 51 && e.keyCode <= 55 ? i.key = String.fromCharCode(e.keyCode - 51 + 27) : e.keyCode === 56 ? i.key = P.DEL : e.keyCode === 219 ? i.key = P.ESC : e.keyCode === 220 ? i.key = P.FS : e.keyCode === 221 && (i.key = P.GS);
			...
			let t = Io[e.keyCode]?.[+!!e.shiftKey];
			if (t) i.key = P.ESC + t;
			else if (e.keyCode >= 65 && e.keyCode <= 90) {
				let t = e.ctrlKey ? e.keyCode - 64 : e.keyCode + 32, n = String.fromCharCode(t);
				e.shiftKey && (n = n.toUpperCase()), i.key = P.ESC + n;
			} else if (e.keyCode === 32) i.key = P.ESC + (e.ctrlKey ? P.NUL : " ");
			else if (e.key === "Dead" && e.code.startsWith("Key")) {
				let t = e.code.slice(3, 4);
				e.shiftKey || (t = t.toLowerCase()), i.key = P.ESC + t, i.cancel = !0;
			}
		} else n && !e.altKey && !e.ctrlKey && !e.shiftKey && e.metaKey ? e.keyCode === 65 && (i.type = 1) : e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && e.key.length === 1 ? i.key = e.key : e.key && e.ctrlKey && (e.key === "_" && (i.key = P.US), e.key === "@" && (i.key = P.NUL));
	}
	return i;
}
var Y = 0, Ro = class {
	constructor(e) {
		this._getKey = e, this._array = [], this._insertedValues = [], this._flushInsertedTask = new Ai(), this._isFlushingInserted = !1, this._deletedIndices = [], this._flushDeletedTask = new Ai(), this._isFlushingDeleted = !1;
	}
	clear() {
...
}, zo = 0, Bo = 0, Vo = class extends D {
	constructor() {
		super(), this._decorations = new Ro((e) => e?.marker.line), this._onDecorationRegistered = this._register(new A()), this.onDecorationRegistered = this._onDecorationRegistered.event, this._onDecorationRemoved = this._register(new A()), this.onDecorationRemoved = this._onDecorationRemoved.event, this._register(E(() => this.reset()));
	}
	get decorations() {
	...
	*getDecorationsAtCell(e, t, n) {
	...
	forEachDecorationAtCell(e, t, n, r) {
		this._decorations.forEachByKey(t, (t) => {
			zo = t.options.x ?? 0, Bo = zo + (t.options.width ?? 1), e >= zo && e < Bo && (!n || (t.options.layer ?? "bottom") === n) && r(t);
		});
	}
}, Ho = class extends Ke {
	constructor(e) {
		super(), this.options = e, this.onRenderEmitter = this.add(new A()), this.onRender = this.onRenderEmitter.event, this._onDispose = this.add(new A()), this.onDispose = this._onDispose.event, this._cachedBg = null, this._cachedFg = null, this.marker = e.marker, this.options.overviewRulerOptions && !this.options.overviewRulerOptions.position && (this.options.overviewRulerOptions.position = "full");
	}
	get backgroundColorRGB() {
		return this._cachedBg === null && (this._cachedBg = this.options.backgroundColor ? V.toColor(this.options.backgroundColor) : void 0), this._cachedBg;
	}
	get foregroundColorRGB() {
		return this._cachedFg === null && (this._cachedFg = this.options.foregroundColor ? V.toColor(this.options.foregroundColor) : void 0), this._cachedFg;
	}
	dispose() {
	...
	_handleChar(e) {
		this._liveRegionLineCount < Go + 1 && (this._charsToConsume.length > 0 ? this._charsToConsume.shift() !== e && (this._charsToAnnounce += e) : this._charsToAnnounce += e, e === "\n" && (this._liveRegionLineCount++, this._liveRegionLineCount === Go + 1 && (this._liveRegion.textContent += c.get())));
	}
	_clearLiveRegion() {
...
var qo = class extends D {
	constructor(e, t, n, r, i) {
		super(), this._element = e, this._mouseService = t, this._renderService = n, this._bufferService = r, this._linkProviderService = i, this._linkCacheDisposables = [], this._isMouseOut = !0, this._wasResized = !1, this._activeLine = -1, this._onShowLinkUnderline = this._register(new A()), this.onShowLinkUnderline = this._onShowLinkUnderline.event, this._onHideLinkUnderline = this._register(new A()), this.onHideLinkUnderline = this._onHideLinkUnderline.event, this._register(E(() => {
			Ue(this._linkCacheDisposables), this._linkCacheDisposables.length = 0, this._lastMouseEvent = void 0, this._activeProviderReplies?.clear();
		})), this._register(this._bufferService.onResize(() => {
			this._clearCurrentLink(), this._wasResized = !0;
		})), this._register(j(this._element, "mouseleave", () => {
			this._isMouseOut = !0, this._clearCurrentLink();
		})), this._register(j(this._element, "mousemove", this._handleMouseMove.bind(this))), this._register(j(this._element, "mousedown", this._handleMouseDown.bind(this))), this._register(j(this._element, "mouseup", this._handleMouseUp.bind(this)));
	}
	get currentLink() {
	...
	_handleMouseUp(e) {
		...
		let t = this._positionFromMouseEvent(e, this._element, this._mouseService);
		t && this._mouseDownLink && Jo(this._mouseDownLink.link, this._currentLink.link) && this._linkAtPosition(this._currentLink.link, t) && this._currentLink.link.activate(e, this._currentLink.link.text);
	}
	_clearCurrentLink(e, t) {
		!this._currentLink || !this._lastMouseEvent || (!e || !t || this._currentLink.link.range.start.y >= e && this._currentLink.link.range.end.y <= t) && (this._linkLeave(this._element, this._currentLink.link, this._lastMouseEvent), this._currentLink = void 0, Ue(this._linkCacheDisposables), this._linkCacheDisposables.length = 0);
	}
	_handleNewLink(e) {
...
var Yo = class extends Fo {
	...
	_handleColorEvent(e) {
		if (this._themeService) for (let t of e) {
			...
			switch (t.type) {
				case 0:
					let r = B.toColorRGB(e === "ansi" ? this._themeService.colors.ansi[t.index] : this._themeService.colors[e]);
					this.coreService.triggerDataEvent(`${P.ESC}]${n};${yo(r)}${Ar.ST}`);
					break;
				case 1:
					if (e === "ansi") this._themeService.modifyColors((e) => e.ansi[t.index] = z.toColor(...t.color));
					else {
						let n = e;
						this._themeService.modifyColors((e) => e[n] = z.toColor(...t.color));
					}
					break;
	...
	_handleScreenReaderModeOptionChange(e) {
		e ? !this._accessibilityManager.value && this._renderService && (this._accessibilityManager.value = this._instantiationService.createInstance(Ko, this)) : this._accessibilityManager.clear();
	}
	...
	_initGlobal() {
		this._bindKeys(), this._register(j(this.element, "copy", (e) => {
			this.hasSelection() && d(e, this._selectionService);
		}));
		let e = (e) => f(e, this.textarea, this.coreService, this.optionsService);
		this._register(j(this.textarea, "paste", e)), this._register(j(this.element, "paste", e)), _i ? this._register(j(this.element, "mousedown", (e) => {
			e.button === 2 && h(e, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
		})) : this._register(j(this.element, "contextmenu", (e) => {
			h(e, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
		})), Ti && this._register(j(this.element, "auxclick", (e) => {
			e.button === 1 && m(e, this.textarea, this.screenElement);
		}));
	}
	_bindKeys() {
		this._register(j(this.textarea, "keyup", (e) => this._keyUp(e), !0)), this._register(j(this.textarea, "keydown", (e) => this._keyDown(e), !0)), this._register(j(this.textarea, "keypress", (e) => this._keyPress(e), !0)), this._register(j(this.textarea, "compositionstart", () => this._compositionHelper.compositionstart())), this._register(j(this.textarea, "compositionupdate", (e) => this._compositionHelper.compositionupdate(e))), this._register(j(this.textarea, "compositionend", () => this._compositionHelper.compositionend())), this._register(j(this.textarea, "input", (e) => this._inputEvent(e), !0)), this._register(this.onRender(() => this._compositionHelper.updateCompositionElements()));
	}
	open(e) {
		...
		})), this._selectionService = this._register(this._instantiationService.createInstance(ea, this.element, this.screenElement, r)), this._instantiationService.setService(xe, this._selectionService), this._register(this._selectionService.onRequestScrollLines((e) => this.scrollLines(e.amount, e.suppressScrollEvent))), this._register(this._selectionService.onSelectionChange(() => this._onSelectionChange.fire())), this._register(this._selectionService.onRequestRedraw((e) => this._renderService.handleSelectionChanged(e.start, e.end, e.columnSelectMode))), this._register(this._selectionService.onLinuxMouseSelection((e) => {
			this.textarea.value = e, this.textarea.focus(), this.textarea.select();
		})), this._register(k.any(this._onScroll.event, this._inputHandler.onScroll)(() => {
			this._selectionService.refresh(), this._viewport?.queueSync();
		})), this._register(this._instantiationService.createInstance(Cr, this.screenElement)), this._register(j(this.element, "mousedown", (e) => this._selectionService.handleMouseDown(e))), this.coreMouseService.areMouseEventsActive ? (this._selectionService.disable(), this.element.classList.add("enable-mouse-events")) : this._selectionService.enable(), this.options.screenReaderMode && (this._accessibilityManager.value = this._instantiationService.createInstance(Ko, this)), this._register(this.optionsService.onSpecificOptionChange("screenReaderMode", (e) => this._handleScreenReaderModeOptionChange(e))), this.options.overviewRuler.width && (this._overviewRulerRenderer = this._register(this._instantiationService.createInstance(Or, this._viewportElement, this.screenElement))), this.optionsService.onSpecificOptionChange("overviewRuler", (e) => {
			!this._overviewRulerRenderer && e && this._viewportElement && this.screenElement && (this._overviewRulerRenderer = this._register(this._instantiationService.createInstance(Or, this._viewportElement, this.screenElement)));
		}), this._charSizeService.measure(), this.refresh(0, this.rows - 1), this._initGlobal(), this.bindMouse();
	}
	_createRenderer() {
		return this._instantiationService.createInstance(ti, this, this._document, this.element, this.screenElement, this._viewportElement, this._helperContainer, this.linkifier);
	}
	bindMouse() {
		...
		this._register(this.coreMouseService.onProtocolChange((e) => {
		...
		})), this.coreMouseService.activeProtocol = this.coreMouseService.activeProtocol, this._register(j(t, "mousedown", (e) => {
			...
			if (!r.wheel) {
				...
				if (!this.buffer.hasScrollback) {
					...
					let n = P.ESC + (this.coreService.decPrivateModes.applicationCursorKeys ? "O" : "[") + (t.deltaY < 0 ? "A" : "B");
	...
	_keyDown(e) {
		...
		let n = Lo(e, this.coreService.decPrivateModes.applicationCursorKeys, this.browser.isMac, this.options.macOptionIsMeta);
		...
		if ((n.key === P.ETX || n.key === P.CR) && (this.textarea.value = ""), this._onKey.fire({
			key: n.key,
			domEvent: e
	...
	_keyUp(e) {
		this._keyDownSeen = !1, !(this._customKeyEventHandler && this._customKeyEventHandler(e) === !1) && (Xo(e) || this.focus(), this.updateCursorStyle(e), this._keyPressHandled = !1);
	}
	_keyPress(e) {
		let t;
...
var Zo = class {
	...
	constructor(e) {
		super(), this._core = e, this._onBufferChange = this._register(new A()), this.onBufferChange = this._onBufferChange.event, this._normal = new $o(this._core.buffers.normal, "normal"), this._alternate = new $o(this._core.buffers.alt, "alternate"), this._core.buffers.onBufferActivate(() => this._onBufferChange.fire(this.active));
	}
	get active() {
...
}, rs = ["cols", "rows"], is = 0, as = class extends D {
	constructor(e) {
		super(), this._core = this._register(new Yo(e)), this._addonManager = this._register(new Zo()), this._publicOptions = { ...this._core.options };
	...
	_checkReadonlyOptions(e) {
		if (rs.includes(e)) throw Error(`Option "${e}" can only be set in the constructor`);
	}
	_checkProposedApi() {
	...
	get parser() {
		return this._parser ||= new ts(this._core), this._parser;
	}
	get unicode() {
		return this._checkProposedApi(), new ns(this._core);
	}
	get textarea() {
	...
	get buffer() {
		return this._buffer ||= this._register(new es(this._core)), this._buffer;
	}
	get markers() {
	...
	_verifyIntegers(...e) {
		for (is of e) if (is === 1 / 0 || isNaN(is) || is % 1 != 0) throw Error("This API only accepts integers");
	}
	_verifyPositiveIntegers(...e) {
		for (is of e) if (is && (is === 1 / 0 || isNaN(is) || is % 1 != 0 || is < 0)) throw Error("This API only accepts positive integers");
	}
}, os = 2, ss = 1, cs = class {
	activate(e) {
		this._terminal = e;
	...
	proposeDimensions() {
		...
		return {
			cols: Math.max(os, Math.floor(u / e.css.cell.width)),
			rows: Math.max(ss, Math.floor(l / e.css.cell.height))
		};
	}
}, ls = class {
	constructor(e, t, n, r = {}) {
	...
	provideLinks(e, t) {
		let n = ds.computeLink(e, this._regex, this._terminal, this._handler);
...
var ms = class {
	...
	activate(e) {
		this._terminal = e;
		let t = this._options, n = t.urlRegex || fs;
		this._linkProvider = this._terminal.registerLinkProvider(new ls(this._terminal, n, this._handler, t));
	}
	dispose() {
...
function vs(e) {
	...
	for (let o of e.trim()) {
		...
		if ("|;&<>".includes(o)) throw Error("Pipes, redirection, and scripts are not supported. Try help.");
		/\s/.test(o) ? (i && t.push(n), n = "", i = !1) : (n += o, i = !0);
	}
	if (r || a) throw Error("Close the quote or finish the escape, then try again.");
	return i && t.push(n), t;
}
function ys(e) {
	let t = e.trimStart().replace(/^\//, "").toLowerCase();
	return /\s/.test(t) ? [] : gs.filter((e) => e.startsWith(t));
}
var bs = class {
	entries = [];
	cursor = 0;
	draft = "";
	add(e) {
		e && this.entries.at(-1) !== e && this.entries.push(e), this.entries.length > 100 && this.entries.shift(), this.cursor = this.entries.length, this.draft = "";
	}
	move(e, t) {
		return this.cursor === this.entries.length && (this.draft = t), this.cursor = Math.max(0, Math.min(this.entries.length, this.cursor + e)), this.entries[this.cursor] ?? this.draft;
	}
};
function xs(e, t, n) {
	let r = (e) => ({
	...
	if (a === "theme") {
		...
		return i.length > 1 || ![
			...
			"system",
			"toggle"
		].includes(e) ? r("Usage: theme [light | dark | system]") : {
			action: "theme",
			theme: e,
			lines: [],
			code: 0
	...
	if (a === "help") return {
		lines: [
			...
			{ text: "" },
			...gs.map((e) => ({
				text: `  ${e.padEnd(16)}${hs[e]}`,
				style: "command"
			})),
			{ text: "" },
			{
				text: "Click a command, or type it below. A leading / also works.",
				style: "muted"
			}
		],
		code: 0
...
var Ss = (e) => _s(e.replace(/\s+/g, " ")), Cs = (e) => Ss(e?.textContent ?? "").trim();
function ws(e, t) {
	if (!e) return { text: "" };
	let n = Cs(e), r = t ? n.match(t)?.[0].length ?? 0 : 0, i = [], a = e.ownerDocument.createRange();
	a.selectNodeContents(e);
	for (let t of e.querySelectorAll("strong, b")) {
		a.setEndBefore(t);
		let e = t.textContent?.match(/^\s*/)?.[0] ?? "", n = Math.max(0, Ss(a.toString() + e).trimStart().length - r);
		a.setEndAfter(t);
		let o = Ss(a.toString()).trim().length - r;
		n < o && i.push({
			start: n,
			end: o
		});
...
function Ts(e) {
	let t = new Intl.Segmenter("en", { granularity: "sentence" }), n = [];
	for (let r of e) for (let { segment: e, index: i } of t.segment(r.text)) {
		if (!e.trim()) continue;
		let t = i + e.length - e.trimStart().length, a = i + e.trimEnd().length, o = (r.bold ?? []).map((e) => ({
			start: Math.max(t, e.start) - t,
			end: Math.min(a, e.end) - t
...
function Es(e) {
	return [{
		text: "Hi there, my name is Yingjie Yang.",
		wrap: "viewport"
	}, ...Ts(e)];
}
function Ds(e) {
...
function ks(e, t) {
	function n(t) {
		let n = [], r = e.querySelector(`h2#${t}`)?.nextElementSibling;
		for (; r && r.tagName !== "H2";) n.push(r), r = r.nextElementSibling;
		return n;
	}
	function r(e) {
		let t = [];
		for (let r of n(e)) for (let n of r.querySelectorAll(".profile-card")) {
			t.length && t.push({ text: "" }), t.push({
				...ws(n.querySelector("h3")),
				style: "heading"
			});
			let r = ws(n.querySelector(".profile-card__dates"));
			r.text && t.push({
				...r,
				style: "muted"
			});
			...
			if (a.text && t.push({ text: "" }, ...Ts([a])), e === "publications") {
				...
				t.push(ws(n.querySelector(".profile-card__tag")));
				for (let e of n.querySelectorAll(".profile-card__links a")) {
					let n = e.cloneNode(!0);
					n.querySelectorAll("[aria-hidden=\"true\"]").forEach((e) => e.remove()), t.push({
						text: e.href,
						link: {
							label: Cs(n),
							href: e.href
	...
	let i = (e) => new URL(e || "/", location.href).href;
	return {
		about: {
			title: "About",
			lines: Es(n("about").filter((e) => e.tagName === "P").map((e) => ws(e)))
		},
		news: {
			title: "News",
			lines: Ts(n("news").flatMap((e) => [...e.querySelectorAll("li")].map((e) => ws(e, /^🔥\s*/))))
		},
		education: {
			title: "Education",
			lines: r("education")
...
function Ms(e, t) {
	let n = (e) => [
		...
		3,
		5
	].map((t) => parseInt(e.slice(t, t + 2), 16)), r = n(e), i = n(t);
	return Array.from({ length: js }, (e, t) => "#" + r.map((e, n) => Math.round(e + (i[n] - e) * t / 31).toString(16).padStart(2, "0")).join(""));
}
function Ns(e) {
	return e === "light" ? Ms("#3b6db0", "#187980") : Ms("#83aaf2", "#75d0c2");
}
function Ps(e) {
	return Math.max(...As.map((e) => e.length)) <= e ? [...As] : ["Yingjie Yang"];
}
function Fs(e) {
	let t = Ps(e), n = Math.max(...t.map((e) => e.length));
	return t.map((e) => {
		let t = -1;
		return [...e].map((e, r) => {
			if (e === " ") return e;
			let i = 16 + Math.round(r / Math.max(1, n - 1) * 31), a = i === t ? "" : "\x1B[38;5;" + i + "m";
			return t = i, a + e;
		}).join("") + "\x1B[0m";
	});
}
...
function Is(e) {
	if (e === _s(e)) try {
		...
		if ([
			...
			"http:",
			"mailto:"
		].includes(t.protocol)) return t;
	} catch {}
}
function Ls(e, t) {
	let n = Is(t), r = _s(e);
	return n ? `\x1b]8;;${n.href}\x1b\\${r}\x1b]8;;\x1b\\` : r;
}
//#endregion
...
var X = {
	...
	muted: "\x1B[90m",
	error: "\x1B[31m"
}, Rs = (e, t) => t + _s(e) + X.reset;
function zs(e, t) {
	if (!e) return [""];
	let n = [], r = "";
	for (let i of e.split(/\s+/)) r && r.length + i.length + 1 > t && (n.push(r), r = ""), r += (r ? " " : "") + i;
	return r && n.push(r), n;
}
function Bs(e, t) {
	if (e.link) return Rs(e.link.label.padEnd(16), "") + X.blue + Ls(e.text, e.link.href) + X.reset;
	if (e.style === "command") {
		let t = e.text.match(/^(\s*)(\w+)(\s+)(.*)$/);
		if (t) return t[1] + Rs(t[2], X.blue) + t[3] + Rs(t[4], X.muted);
	}
	let n = e.style === "heading" ? X.bold : e.style === "muted" ? X.muted : e.style === "error" ? X.error : "", r = e.wrap === "viewport" ? t - 2 : Math.min(100, t - 2), i = _s(e.text), a = 0;
	return zs(i, Math.max(20, r)).map((t) => {
		let r = i.indexOf(t, a);
		a = r + t.length;
		let o = (e.bold ?? []).map((e) => ({
			start: Math.max(r, e.start) - r,
			end: Math.min(a, e.end) - r
		})).filter((e) => e.start < e.end);
		if (!o.length) return Rs(t, n);
		let s = [.../* @__PURE__ */ new Set([
			0,
			t.length,
			...o.flatMap((e) => [e.start, e.end])
		])].sort((e, t) => e - t);
		return s.slice(0, -1).map((e, r) => {
			let i = o.some((t) => t.start <= e && e < t.end);
			return Rs(t.slice(e, s[r + 1]), n + (i ? X.bold : ""));
		}).join("");
	}).join("\r\n");
}
//#endregion
//#region src/main.ts
var Vs = document.querySelector("#terminal-app"), Hs = document.querySelector("#terminal-output"), Us = document.querySelector("#terminal-state"), Ws = ks(document.querySelector("#terminal-content").content, Vs.dataset), Gs = new bs(), Ks = matchMedia("(prefers-color-scheme: dark)"), qs = null;
try {
	qs = localStorage.getItem("theme");
} catch {}
function Js(e, t) {
	let n = Is(t);
	n && (n.protocol === "mailto:" ? window.open(n.href, "_self") : window.open(n.href, "_blank", "noopener,noreferrer"));
}
var Z = new as({
...
var Xs = 0;
Z.onScroll(() => {
	Hs.classList.add("is-scrolling"), window.clearTimeout(Xs), Xs = window.setTimeout(() => Hs.classList.remove("is-scrolling"), 1e3);
}), Z.loadAddon(new ms(Js));
function Zs() {
	let e = qs === "light" || qs === "dark" ? qs : Ks.matches ? "dark" : "light";
	document.documentElement.dataset.theme = e;
	let t = getComputedStyle(document.documentElement), n = (e) => t.getPropertyValue("--terminal-" + e).trim();
	Z.options.theme = {
		background: n("bg"),
		foreground: n("fg"),
		cursor: n("accent"),
		cursorAccent: n("bg"),
		selectionBackground: n("selection"),
		brightBlack: n("muted"),
		blue: n("accent"),
		brightBlue: n("accent"),
		green: n("green"),
...
function Qs(e) {
	qs = e === "system" ? null : e === "toggle" ? document.documentElement.dataset.theme === "dark" ? "light" : "dark" : e;
	try {
		qs ? localStorage.setItem("theme", qs) : localStorage.removeItem("theme");
	} catch {}
	Zs();
}
var $s = () => Rs("visitor", X.green + X.bold) + "@" + Rs("jayverse3.github.io", X.blue + X.bold) + ":~$ ", ec = (e) => new Promise((t) => Z.write(e, t));
async function tc() {
	let e = ["", ...Fs(Z.cols)];
	e.push("", "Welcome to my terminal portfolio."), e.push("Type " + Rs("help", X.blue) + " to see available commands."), e.push(Rs("Tab to complete · ↑/↓ for history · Ctrl+L to clear", X.muted), ""), await ec(e.join("\r\n") + "\r\n");
}
...
async function oc() {
	nc?.dispose(), nc = Z.registerMarker(0), await ec($s());
}
async function sc(e = !1) {
	Z.scrollToBottom();
	let t = "\x1B[?2026h";
	if (nc && !nc.isDisposed) {
		let e = Z.buffer.active.baseY + Z.buffer.active.cursorY - nc.line;
		t += "\r" + (e > 0 ? "\x1B[" + e + "A" : "") + "\x1B[0J";
	}
	e && (t += "\x1B[2J\x1B[H"), await ec(t);
	try {
		nc?.dispose(), nc = Z.registerMarker(0);
		let e = [...Q];
		await ec($s() + e.slice(0, $).join("")), Z.buffer.active.cursorX >= Z.cols && await ec("\r\n");
		let t = Z.buffer.active.cursorX, n = Z.registerMarker(0);
		await ec(e.slice($).join("") + " ");
		let r = Z.buffer.active.baseY + Z.buffer.active.cursorY - n.line;
		await ec((r > 0 ? "\x1B[" + r + "A" : "") + "\x1B[" + (t + 1) + "G"), n.dispose();
	} finally {
		await ec("\x1B[?2026l");
	}
}
async function cc(e = Q) {
	Q = _s(e).trim().slice(0, 512), $ = [...Q].length, await sc(), await ec("\r\n");
	let t = Q;
	if (Q = "", $ = 0, nc?.dispose(), nc = void 0, !t) {
		await oc();
		return;
	}
	Gs.add(t);
	...
	n.action === "clear" ? Z.reset() : n.action === "welcome" ? await tc() : (n.action === "theme" && (Qs(n.theme), n.lines.push({
		text: "Theme: " + (n.theme === "system" ? "system" : document.documentElement.dataset.theme),
		style: "muted"
	})), await ec(n.lines.map((e) => Bs(e, Z.cols)).join("\r\n") + "\r\n\r\n")), await oc(), Z.scrollToBottom();
}
async function lc(e) {
	let t = [...Q];
	if (e === "\r") {
	...
	if (e === "	") {
		let e = ys(Q);
		e.length === 1 ? (Q = e[0] + " ", $ = Q.length, await sc()) : e.length > 1 && ($ = t.length, await sc(), await ec("\r\n" + e.map((e) => Rs(e, X.blue)).join("  ") + "\r\n"), nc?.dispose(), nc = void 0, await sc());
		return;
	}
	if (e === "\x1B[A" || e === "" || e === "\x1B[B" || e === "") Q = Gs.move(e === "\x1B[A" || e === "" ? -1 : 1, Q), $ = [...Q].length;
	else if (e === "\x1B[D") $ = Math.max(0, $ - 1);
	else if (e === "\x1B[C") $ = Math.min(t.length, $ + 1);
	else if ([
		"",
		"\x1B[H",
		"\x1B[1~",
	...
	else if (e === "" || e === "\b") $ > 0 && t.splice(--$, 1), Q = t.join("");
	else if (e === "\x1B[3~" || e === "") t.splice($, 1), Q = t.join("");
	else if (e === "") Q = t.slice($).join(""), $ = 0;
	else if (e === "\v") Q = t.slice(0, $).join("");
	else if (e === "") {
		let e = t.slice(0, $).join("").replace(/\S+\s*$/, "");
		Q = e + t.slice($).join(""), $ = [...e].length;
	} else if (e.startsWith("\x1B")) return;
	else {
		let n = [..._s(e.replace(/[\r\n\t]+/g, " "))].slice(0, 512 - t.length);
		t.splice($, 0, ...n), Q = t.join(""), $ += n.length;
	}
	await sc();
}
Z.onData((e) => {
	ic && ac(() => lc(e));
}), Z.attachCustomKeyEventHandler((e) => !((e.ctrlKey || e.metaKey) && e.key.toLowerCase() === "c" && Z.hasSelection() || (e.ctrlKey || e.metaKey) && e.key.toLowerCase() === "v" || e.shiftKey && e.key === "Tab")), Z.registerLinkProvider({ provideLinks(e, t) {
	let n = (Z.buffer.active.getLine(e - 1)?.translateToString(!0) || "").match(/^ {2}([a-z]+)(?= {2,})/);
	if (!n || !Object.hasOwn(hs, n[1])) {
		t(void 0);
		return;
	}
	t([{
	...
	e.key === "theme" && (qs = e.newValue, Zs());
}), window.addEventListener("pageshow", (e) => {
	e.persisted && ic && ac(async () => {
		try {
			qs = localStorage.getItem("theme");
		} catch {}
		Zs(), Ys.fit(), await sc(), Z.focus();
	});
});
async function uc() {
	Zs(), Z.open(Hs), Z.textarea?.setAttribute("aria-label", "Terminal command input. Type help for available commands."), await document.fonts.ready, Ys.fit(), Us.hidden = !0, await ec($s() + "welcome\r\n"), await tc(), await oc(), ic = !0, Vs.dataset.ready = "true", Z.focus();
	let e = 0;
	new ResizeObserver(() => {
		cancelAnimationFrame(e), e = requestAnimationFrame(() => ac(async () => {
			Ys.fit(), await sc();
		}));
	}).observe(Hs);
}
